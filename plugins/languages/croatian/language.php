...
$Translation = [
	...
	'no' => 'Ne',
	'group' => 'Grupa',
	'check availability' => 'Provjeri da li je korisničko ime zauzeto',
	'password' => 'Šifra',
	'confirm password' => 'Potvrdi šifru',
	'email' => 'Email Adresa',
	'ok' => 'U redu',
	'username' => 'Korisničko ime',
	'delete record' => 'Obriši podatak',
	'select a table' => 'Skoči na ...',
	'quick search' => 'Brza pretraga',
	'records x to y of z' => 'Unosi <FirstRecord> do <LastRecord> od <RecordCount>',
	'filters' => 'Filteri',
	'filter' => 'Filter',
	'filtered field' => 'Filtrirana polja',
	'comparison operator' => 'Operator poređenja',
	'comparison value' => 'Vrijednost poređenja',
	'and' => 'I',
	'or' => 'Ili',
	'equal to' => 'Jednako',
	...
	'apply filters' => 'Dodaj filtere',
	'save filters' => 'Sačuvaj i primjeni filtere',
	'saved filters title' => 'HTML Kod Za Primjenjene Filtere',
	'saved filters instructions' => 'Kopiraj kod ispod i zalijepi u HTML fajl da bi ste sačuvali filter koji ste definirali da biste mogli da se vratite na isti bilo kada u budućnosti bez potrebe za izmjenama. Možete sačuvati ovaj HTML kod na Vaš računar ili na bilo koji server i pristupiti ovoj unaprijed filtriranoj tabeli.',
	'hide code' => 'Sakrij ovaj kod',
	'printer friendly view' => 'Pregled prilagođen štampaču',
	'save as csv' => 'Skini kao csv fajl (zarezom-odvojene vrijednosti)',
	'edit filters' => 'Izmjeni filtere',
	'clear filters' => 'Ukloni filtere',
	'order by' => 'Sortiraj po',
	'go to page' => 'Idi na stranicu:',
	'none' => 'Ništa',
	'Select all records' => 'Izaberi sve unose',
	'With selected records' => 'Sa izabranim unosima',
	'Print Preview Detail View' => 'Detaljni pregled prije štampe',
	'Print Preview Table View' => 'Tabelarni Pregled prije štampe',
	'Print' => 'Pregled prije ispisa',
	'Cancel Printing' => 'Prekini ispis',
	'Cancel Selection' => 'Ukloni Izbor',
	'Maximum records allowed to enable this feature is' => 'Maksimalni broj podataka koji omogućava ovu funkciju je',
	'No matches found!' => 'Nije nađeno podudaranje!',
	'Start typing to get suggestions' => 'Započnite sa tipkanjem da dobijete prijedloge.',
	'are you sure?' => 'Da li želite da izbrišete ovaj podatak?',
	'add new record' => 'Dodaj novi podatak',
	'update record' => 'Izmjeni podatak',
	'deselect record' => 'Deselektiraj podatak',
	"couldn't delete" => 'Nije moguće izbrisati podatak zbog postojanja <RelatedRecords> vezanog podatka u tabeli [<TableName>]',
	'confirm delete' => 'Ovaj unos ima <RelatedRecords> vezani unos u tabeli [<TableName>]. Da li i dalje želite izbrisati? <Delete> &nbsp; <Cancel>',
	'yes' => 'Da',
	'pkfield empty' => ' polje je primarni ključ i nije moguće da bude prazan.',
	'upload image' => 'Pošalji novi fajl ',
	'select image' => 'Izaberi sliku ',
	'remove image' => 'Izbriši fajl',
	...
	'*' => '*',
	'today' => 'Danas',
	'Hold CTRL key to select multiple items from the above list.' => 'Držite CTRL tipku da biste izabrali više stavki iz gornje liste.',
	'Save New' => 'Spremi novi',
	'Save As Copy' => 'Spremi kao kopiju',
	'Deselect' => 'Deselektiraj',
	'Add New' => 'Dodaj Novi',
	'Delete' => 'Obriši',
	'Cancel' => 'Otkaži',
	'Print Preview' => 'Pregled prije ispisa',
	'Save Changes' => 'Spremi Izmjene',
	'CSV' => 'Spremi CSV',
	...
	'query:' => 'Pitanje:',
	'< back' => '&lt; Povratak',
	"if you haven't set up" => "Ako niste podesili bazu, možete to uraditi klikom <a href='setup.php'>ovde</a>.",
	'file too large' => 'Greška: Fajl koji ste poslali premašuje dozvoljenu veličinu od <MaxSize> KB',
	'invalid file type' => 'Greška: Tip fajla nije dozvoljen. Samo <FileTypes> fajlovi mogu biti poslati',
	'goto start page' => 'Povratak na početnu stranicu',
	'no db connection' => 'Nije moguće uspostaviti konekciju sa bazom.',
	'no db name' => "Nije moguće pristupiti bazi pod imenom '<DBName>' na ovom serveru.",
	'provide connection data' => 'Molimo unesite slijedeće podatke da bi napravili vezu ka bazi:',
	'mysql server' => 'MySQL server (host)',
	'mysql username' => 'MySQL Korisničko Ime',
	'mysql password' => 'MySQL šifra',
	'mysql db' => 'Naziv baze',
	'connect' => 'Poveži se',
	'setup performed' => 'Podešavanje je već izvršeno na',
	'delete md5' => "Ukoliko želite da pokušate podešavanje opet, trebalo bi da prvo izbrišete fajl 'setup.md5' iz ovog direktorija.",
	'table exists' => 'Tabela <b><TableName></b> postoji i sadrži <NumRecords> unosa.',
	'failed' => 'Nije Uspjelo',
	'mysql said' => 'MySQL odgovor:',
	'table uptodate' => 'Tabela je ažurna.',
	'couldnt count' => 'Nije moguće prebrajanje unosa u tabeli <b><TableName></b>',
	'creating table' => 'Pravljenje tabele <b><TableName></b> ... ',
	'tableAccessDenied' => 'Oprostite! Nemate dozvolu pristupa ovoj tabeli. Kontaktirajte administratora.',
	'not signed in' => 'Niste prijavljeni',
	'sign in' => 'Prijavi se',
	'signed as' => 'Prijavi se kao',
	'admin setup needed' => 'Admin podešavanje nije izvršeno. Molimo prijavite se na <a href=admin/>admin kontrolni panel</a> da biste izvršili podešavanje.',
	'db setup needed' => 'Programsko podešavanje nije izvršeno. Molimo prijavite se na <a href=setup.php>na stranicu podešavanja</a> prvo.',
	'new record saved' => 'Novi unos je sačuvan uspešno.',
	'record updated' => 'Izmjene su uspešno spremljene.',
	'login failed' => 'Vaše prethodne probe prijava su neuspješne. Pokušajte opet.',
	'sign in here' => 'Prijavite se ovdje',
	'remember me' => 'Zapamti me',
	'go to signup' => 'Nemate korisničko ime? <br>&nbsp; <a href=membership_signup.php>Upišite se ovdje</a>',
	'forgot password' => 'Zaboravili ste šifru? <a href=membership_passwordReset.php>Kliknite ovdje</a>',
	'browse as guest' => '<a href=index.php>Nastavite razgledanje kao gost</a>',
	'no table access' => 'Nemate dovoljno dozvola da biste pristupili stranici ovdje. Molimo prijavite se prvo.',
	'signup' => 'Upišite se',
	'user already exists' => "Korisničko ime '<MemberID>' već postoji. Pokušajte neko drugo.",
	'user available' => "Korisničko ime '<MemberID>' je slobodno i možete ga zauzeti.",
	'empty user' => "Molimo unesite korisničko ime u polje prvo i kliknite 'Provjeri dostupnost'.",
	'thanks' => 'Hvala Vam što ste se upisali!',
	'sign in no approval' => 'Ukoliko ste izabrali grupu koja ne zahtjeva odobrenje admina, možete se odmah prijaviti <a href=index.php?signIn=1>ovde</a>.',
	'sign in wait approval' => 'Ukoliko ste izabrali grupu koja zahtjeva odobrenje admina, molimo sačekajte email koji Vam odobrava korišćenje.',
	'username empty' => 'Morate obezbediti korisničko ime. Vratite se nazad i utipkajte korisničko ime',
	'password invalid' => 'Morate obezbjediti šifru sa 4 znaka ili više, bez razmaka. Vratite se nazad i unesite ispravnu šifru',
	'password no match' => 'Šifra se ne slaže. Vratite se nazad i ispravite šifru',
	'username exists' => 'Korisničko ime već postoji. Vratite se nazad i izaberite drugo korisničko ime.',
	'email invalid' => 'Neispravna email adresa. Vratite se nazad i ispravite email adresu.',
	'group invalid' => 'Neispravna grupa. Vratite se nazad i izmjenite izbor grupe.',
	'sign up here' => 'Upišite Se Ovdje!',
	'registered? sign in' => 'Već ste registrirani? <a href=index.php?signIn=1>Prijavite se ovdje</a>.',
	'sign up disabled' => 'Oprostite! Upis je trenutno isključen od strane admina. Pokušajte kasnije.',
	'groups *' => 'Ukoliko ste izabrali da se upišete u grupu označenu zvezdicom(*), nećete se moći prijaviti dok Vas admin ne odobri. Primićete email kada budete odobreni.',
	'sign up' => 'Upišite se',
	'password reset' => 'Stranica za Resetiranje šifre',
	'password reset details' => 'Unesite Vaše korisničko ime ili email adresu ispod. Mi ćemo Vam poslati specijalni link na Vaš email. Kada kliknete na taj link, imaćete ponuđeno da unesete novu šifru.',
	'password reset subject' => 'Uputa za resetiranje šifre',
	'password reset message' => "Dragi članu, \n Ukoliko ste zahtjevali da resetirate/izmjenite Vašu šifru, molimo kliknite na sledeći link: \n <ResetLink> \n\n Ukoliko niste poslali zahtjev za resetom/izmjenom šifre, ignorirajte ovu poruku. \n\n Pozdrav.",
	'password reset ready' => 'Email sa uputama za resetiranje šifre je poslat na Vašu registriranu email adresu. Molimo ostavite otvorenu ovu stranicu i pratite upute iz email poruke.<br><br>Ukoliko ne primite ovu poruku u slijedećih 5 minuta, pokušajte sa resetom šifre opet, i proverite da li ste unijeli korisničko ime ili email adresu ispravno.',
	'password reset invalid' => 'Neispravno korisničko ime ili šifra. <a href=membership_passwordReset.php>Pokušajte opet</a>, ili idite na <a href=index.php>početnu stranicu</a>.',
	'password change' => 'Stranica za Izmjenu šifre',
	'new password' => 'Nova šifra',
	'password reset done' => 'Vaša šifra je uspješno izmjenjena. Možete se <a href=index.php?signOut=1>prijaviti sa novom šifrom ovdje</a>.',
	'Loading ...' => 'Učitavanje ...',
	'No records found' => 'Nema nađenih podataka',
	'You can add children records after saving the main record first' => 'Možete dodati subpodatke nakon spremanja glavnih podataka',
	'ascending' => 'Rastuće',
	...
	'Edit' => 'Izmjeni',
	'View' => 'Pogledaj',
	'Only your own records' => 'Samo svoje podatke',
	'All records owned by your group' => 'Sve podatke vlasništva svoje grupe',
	'All records' => 'Sve podatke',
	'Not allowed' => 'Zabranjeno',
	'Your info' => 'Vaš info',
	'Hello user' => 'Zdravo %s!',
	'Your access permissions' => 'Vaša pristupna prava',
	'Update profile' => 'Izmjeni profil',
	'Update password' => 'Ažuriraj šifru',
	'Change your password' => 'Izmjeni šifru',
	'Old password' => 'Stara šifra',
	'Password strength: weak' => 'Težina šifre: slaba',
	'Password strength: good' => 'Težina šifre: dobra',
	'Password strength: strong' => 'Težina šifre: jaka',
	'Wrong password' => 'Pogrešna šifra',
	'Your profile was updated successfully' => 'Vaš profil je uspješno izmjenjen',
	'Your password was changed successfully' => 'Vaša šifra je uspješno izmjenjena',
	'Your IP address' => 'Vaša IP adresa',
	'Records to display' => 'podataka za prikaz',
	'Jump to' => 'Skoči na ...',
	'check username availability' => 'Provjeri da li je korisničko ime zauzeto',
