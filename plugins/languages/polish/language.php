...
$Translation = [
	...
	'no' => 'Nie',
	'group' => 'Grupa',
	'check availability' => 'Sprawdź nazwę użytkownika',
	'password' => 'Hasło',
	'confirm password' => 'Potwierdź hasło',
	'email' => 'Adres e-mail',
	'ok' => 'Ok',
	'username' => 'Użytkownik',
	'delete record' => 'Skasuj pozycję',
	'select a table' => 'Przejdź do...',
	'quick search' => 'Szybkie wyszukiwanie',
	'records x to y of z' => 'Pozycje od <FirstRecord> do <LastRecord> z <RecordCount>',
	'filters' => 'Filtry',
	'filter' => 'Filtr',
	'filtered field' => 'Pola filtrowane',
	'comparison operator' => 'Typ porównania',
	...
	'like' => 'Podobne do',
	'not like' => 'Niepodobne do',
	'is empty' => 'Jest pusty',
	'is not empty' => 'Nie jest pusty',
	'apply filters' => 'Zastosuj filtry',
	'save filters' => 'Zapisz i zastosuj filtry',
	'saved filters title' => 'Kod HTML dla zastosowanych filtrów',
	'saved filters instructions' => 'Skopiuj kod znajdujący się poniżej do dowolnego pliku HTML by zapisać filtr który właśnie zdefiniowałeś - dzięki temu można do niego wrócić w każdej chwili bez konieczności ponownego definiowania. Kod ten pozwala wyświetlić gotową tabelę',
	'hide code' => 'Ukryj kod',
	'printer friendly view' => 'Widok do drukowania',
	'save as csv' => 'Zapisz na dysku jako pliki csv(oddzielone przecinkami))',
	'edit filters' => 'Edytuj filtry',
	'clear filters' => 'Wyczyść filtry',
	'order by' => 'Sortowanie',
	'go to page' => 'Idź do strony:',
	'none' => 'Brak',
	'are you sure?' => 'Jesteś pewien, że chcesz skasować ten wpis?',
	'add new record' => 'Dodaj nowy wpis',
	'update record' => 'Popraw pozycję',
	'deselect record' => 'Odznacz pozycję',
	"couldn't delete" => "Nie można skasować pozycji z powodu obecności <RelatedRecords> powiązanych pozycji w tabeli '<TableName>'",
	'confirm delete' => "Ta pozycja ma <RelatedRecords> powiązanych pozycji w tabeli '<TableName>'. Czy nadal chcesz skasować pozycję <Delete> &nbsp; <Cancel>",
	'yes' => 'Tak',
	'pkfield empty' => " pole jest typu 'primary key' i nie może być puste.",
	...
	'field not null' => 'To pole nie może być puste',
	'*' => '*',
	'today' => 'Dzisiaj',
	...
	'query:' => 'Zapytanie:',
	'< back' => '&lt; Wróć',
	"if you haven't set up" => "Jeśli nie skonfigurowałeś jeszcze bazy danych, możesz to zrobić klikając <a href='setup.php'>TUTAJ</a>.",
	'file too large' => 'Błąd: Wgrany plik przekracza maksymalny dopuszczalny rozmiar <MaxSize> KB',
	'invalid file type' => 'Błąd: Ten typ pliku jest zabroniony. Tylko pliki <FileTypes> mogą być wgrywane',
	'goto start page' => 'Wróć do Strony Głównej',
	'no db connection' => 'Nie można połączyć się z bazą danych',
	'no db name' => "Nie można uzyskać dostępu do bazy danych '<DBName>' na tym serwerze.",
	'provide connection data' => 'Podaj informacje o Bazie Danych:',
	'mysql server' => 'Serwer MYSQL(host)',
	'mysql username' => 'Użytkownik MYSQL',
	'mysql password' => 'Hasło MYSQL',
	'mysql db' => 'Nazwa Bazy Danych MYSQL',
	'connect' => 'Wykonaj',
	'setup performed' => 'Konfiguracja została już wykonana',
	'delete md5' => "Jeśli chcesz uruchomić konfigurację jeszcze raz, Musisz najpierw skasować 'setup.md5' z tego folderu.",
	'table exists' => 'Tabela <b><TableName></b> już istnieje, liczba wpisów: <NumRecords> .',
	'failed' => 'Nie udało się',
	'mysql said' => 'Odpowiedź MySQL:',
	'table uptodate' => 'Tabela uaktualniona.',
	'couldnt count' => 'Nie można policzyć wpisów w Tabeli  <b><TableName></b>',
	'creating table' => 'Tworzenie Tabeli <b><TableName></b> ... ',
	'tableAccessDenied' => 'Nie masz uprawnień do tej tabeli. Skontaktuj się z administratorem.',
	'not signed in' => 'Nie jesteś zalogowany',
	'sign in' => 'Zaloguj',
	'signed as' => 'Zalogowany jako',
	'admin setup needed' => 'Konfiguracja Administratora nie została wykonana. Zaloguj się do  <a href=admin/>Panelu Administratora</a> by dokonać konfiguracji.',
	'db setup needed' => 'Konfiguracja nie została jeszcze wykonana. Otwórz <a href=setup.php>stronę konfiguracji</a>.',
	'login failed' => 'Logowanie nie powiodło się. Spróbuj ponownie.',
	'sign in here' => 'Zaloguj się',
	'go to signup' => 'Nie masz konta? <br>&nbsp; <a href=membership_signup.php>Zarejestruj się!</a>',
	'browse as guest' => 'Lub <a href=index.php>naciśnij tutaj</a> by przeglądać stronę <br> jako gość.',
	'no table access' => 'Nie masz uprawnień do oglądania tej strony. Najpierw się zaloguj.',
	'user already exists' => "Nazwa użytkownika '<MemberID>' już istnieje. Wybierz inną nazwę użytkownika.",
	'user available' => "Nazwa użytkownika '<MemberID>' jest dostępna.",
	'empty user' => "Wpisz nazwę użytkowniak a potem naciśnij 'Sprawdź nazwę użytkownika'.",
	'thanks' => 'Dziękujemy za zarejestrowanie się!',
	'sign in no approval' => 'Jeśli wybrałeś grupę, która nie wymaga zatwierdzenia przez administratora, możesz zarejestrować się <a href=index.php?signIn=1>tutaj</a>.',
	'sign in wait approval' => 'Jeśli wybrałeś grupę, która wymaga zatwierdzenia przez administratora, poczekaj na e-mail potwierdzający zatwierdzenie.',
	'username empty' => 'Musisz wprowadzić nazwę użytkownika. Wróć i wprowadź nazwę użytkownika',
	'password invalid' => 'Musisz wprowadzić hasło składające się z minimum 4 znaków(bez odstępów). Wróć i wprowadź poprawne hasło',
	'password no match' => 'Hasła nie pasują do siebie. Wprowdź hasła pasujące do siebie',
	'username exists' => 'Użytkownik już istnieje. Wybierz inną nazwę użytkownika.',
	'email invalid' => 'Błędny adres e-mail. Wprowadź poprawny adres e-mail',
	'group invalid' => 'Zły wybór grupy. Wybierz poprawną grupę.',
	'sign up here' => 'Zarejestruj się!',
	'registered? sign in' => 'Masz już konto? <a href=index.php?signIn=1>Zaloguj się!</a>.',
	'sign up disabled' => 'Przepraszamy! Rejestracja tymczasowo wyłączona przez administratora. Spróbuj póxniej',
	'groups *' => 'Jeśli zapiszesz się do grupy oznaczonej gwiazdką (*), nie będziesz mógł się zalogować do momentu akceptacji przez administratora. W momencie akceptacji otrzymasz e-mail potwierdzający.',
	'sign up' => 'Zarejestruj się',
	'Jump to' => 'Przejdź do...',
	'check username availability' => 'Sprawdź nazwę użytkownika',
