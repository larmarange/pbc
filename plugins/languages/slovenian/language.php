...
$Translation = [
	'language' => 'slovenian',
	'admin area' => 'Administracijski vmesnik',
	'sign out' => 'Odjava',
	'please wait' => 'Prosimo počakajte',
	'no' => 'Ne',
	'group' => 'Skupina',
	'check availability' => 'Preverite, če je uporabniško ime prosto',
	'password' => 'Geslo',
	'confirm password' => 'Potrdite geslo',
	'email' => 'Email naslov',
	'ok' => 'V redu',
	'username' => 'Uporabnik',
	'delete record' => 'Zbrišite zapis',
	'select a table' => 'Skoči do ...',
	...
	'comparison value' => 'Primerjana vrednost',
	'and' => 'In',
	'or' => 'Ali',
	'equal to' => 'Je enako',
	'not equal to' => 'Ni enako',
	'greater than' => 'Večje kot',
	'greater than or equal to' => 'Večje kot ali enako',
	'less than' => 'Manj kot',
	'less than or equal to' => 'Manj kot ali enako',
	'like' => 'Kot',
	'not like' => 'Ne kot',
	'is empty' => 'Je brez vrednosti',
	'is not empty' => 'Ni brez vrednosti',
	'apply filters' => 'Uveljavi filtre',
	'save filters' => 'Shrani in uveljavi filtre',
	'saved filters title' => 'HTML koda za aktivne filtre',
	'saved filters instructions' => 'Kopirajte spodnjo kodo in jo prilepite v HTML datoteko, da shranite filter, ki ste ga pravkar definirali, da vam ga v prihodnje ne bo potrebno ponovno definirati. HTML kodo si lahko shranite lokalno na vaš računalnik ali na strežnik in jo uporabite kadarkoli za prikaz tabele z izbranimi filtri.',
	'hide code' => 'Skrij kodo',
	'printer friendly view' => 'Tiskanju prijazen pogled',
	'save as csv' => 'Prenesite v CSV obliki (comma-separated values)',
	'edit filters' => 'Uredite filtre',
	'clear filters' => 'Odstranite filtre',
	'order by' => 'Razvrščanje',
	'go to page' => 'Na stran:',
	'none' => 'Nobeden',
	'Select all records' => 'Izberite vse zapise',
	'With selected records' => 'Z izbranimi zapisi',
	'Print Preview Detail View' => 'Predogled tiska v obliki Podrobnosti',
	'Print Preview Table View' => 'Predogled tiska v obliki Tabele',
	'Print' => 'Tiskaj',
	'Cancel Printing' => 'Prekliči tiskanje',
	'Cancel Selection' => 'Prekliči izbor',
	'Maximum records allowed to enable this feature is' => 'Največje število dovoljenih zapisov za izvajanje te funkcije je',
	'No matches found!' => 'Ni zadetkov!',
	'Start typing to get suggestions' => 'Začnite tipkati za prikaz zapisov.',
	'are you sure?' => 'Ste prepričani, da želite odstraniti ta zapis?',
	'add new record' => 'Dodajte nov vnos',
	'update record' => 'Shranite zapis',
	'deselect record' => 'Odznačite zapis',
	"couldn't delete" => 'Zapisa ni bilo možno odstraniti zaradi prisotnosti <RelatedRecords> povezave zapisa(ov) v tabeli [<TableName>]',
	'confirm delete' => 'Ta zapis vsebuje <RelatedRecords> povezan(e) zapis(e) v tabeli [<TableName>]. Želite vseeno odstraniti zapis? <Delete> &nbsp; <Cancel>',
	'yes' => 'Da',
	'pkfield empty' => ' polje je Primarni ključ in ne more biti prazno.',
	'upload image' => 'Prenesite novo datoteko ',
	'select image' => 'Izberite fotografijo ',
	'remove image' => 'Odstranite datoteko',
	'month names' => 'Januar,Februar,Marec,April,Maj,Junij,Julij,Avgust,September,Oktober,November,December',
	'field not null' => 'To polje ne more biti prazno.',
	'*' => '*',
	'today' => 'Danes',
	'Hold CTRL key to select multiple items from the above list.' => 'Držite CTRL tipko, če želite v seznamu označiti več stvari hkrati.',
	'Save New' => 'Shrani Nov',
	...
	'Delete' => 'Zbriši',
	'Cancel' => 'Prekliči',
	'Print Preview' => 'Tiskanje',
	'Save Changes' => 'Shrani spremembe',
	'CSV' => 'Shrani CSV',
	'Reset Filters' => 'Prikaz vseh',
	'Find It' => 'Najdi',
	'Previous' => 'Prejšnji',
	'Next' => 'Naprej',
	'Back' => 'Nazaj',
	...
	'query:' => 'Poizvedba:',
	'< back' => '&lt; Nazaj',
	"if you haven't set up" => "Če še niste namestili podatkovne baze, lahko to storite s klikom <a href='setup.php'>tukaj</a>.",
	'file too large' => 'Napaka: Največja dovoljena velikost prenašane datoteke je <MaxSize> KB',
	'invalid file type' => 'Napaka: Ta tip datotek ni dovoljen. Prenašate lahko samo datoteke tipa <FileTypes>',
	'goto start page' => 'Nazaj na začetno stran',
	'no db connection' => 'Povezava s podatkovno bazo je bila neuspešna.',
	'no db name' => "Ni možno dostopati do '<DBName>' podatkovne baze na tem strežniku.",
	'provide connection data' => 'Prosimo, navedite naslednje podatke za povezavo do podatkovne baze:',
	'mysql server' => 'MySQL server (host)',
	'mysql username' => 'MySQL Uporabniško ime',
	'mysql password' => 'MySQL Geslo',
	'mysql db' => 'Ime podatkovne baze',
	'connect' => 'Poveži',
	'setup performed' => 'Namestitev je bila že izvedena za ',
	'delete md5' => "Če želite ponoviti namestitev morate najprej zbrisati 'setup.md5' iz te mape.",
	'table exists' => 'Tabela <b><TableName></b> že obstaja, in vsebuje <NumRecords> zapisov.',
	'failed' => 'Spodletelo',
	'mysql said' => 'MySQL je javil:',
	'table uptodate' => 'Tabela je posodobljena.',
	'couldnt count' => 'Ni bilo možno prešteti zapise v tabeli <b><TableName></b>',
	'creating table' => 'Ustvarjam tabelo <b><TableName></b> ... ',
	'tableAccessDenied' => 'Oprostite! Nimate pooblastil za dostop do te tabele. Kontaktirajte administratorja.',
	'not signed in' => 'Niste vpisani',
	'sign in' => 'Vpis',
	'signed as' => 'Vpisani kot',
	'admin setup needed' => 'Administrativna namestitev ni bila izvedena. Prosimo, prijavite se v <a href=admin/>administracijsko nadzorno plošco</a> za izvedbo namestitve.',
	'db setup needed' => 'Program še ni nameščen. Prosimo, da se najprej prijavite v <a href=setup.php>namestitev strani</a>.',
	'new record saved' => 'Nov vpis je bil uspešno shranjen.',
	'record updated' => 'Spremembe so bile uspešno shranjene.',
	'login failed' => 'Prejšnji poskus prijave je spodletel. Poskusite znova.',
	'sign in here' => 'Vpišite se tu',
	'remember me' => 'Zapomni si me',
	'go to signup' => 'Še nimate uporabniškega imena? <br>&nbsp; <a href=membership_signup.php>Vpišete se lahko tukaj</a>',
	'forgot password' => 'Ste pozabili geslo? <a href=membership_passwordReset.php>Kliknite tukaj</a>',
	'browse as guest' => 'Ali <a href=index.php>kliknite tukaj</a> za nadaljevanje <br>&nbsp; brskanja kot gost.',
	'no table access' => 'Nimate dovolj pooblastil za brskanje teh strani. Prosimo, da se najprej prijavite.',
	'signup' => 'Vpis',
	'user already exists' => "Uporabnik '<MemberID>' že obstaja. Poskusite izbrati drugo uporabniško ime.",
	'user available' => "Uporabniško ime '<MemberID>' je še prosto in ga lahko uporabite.",
	'empty user' => "Prosimo, da vpišite uporabniško ime in kliknete 'Preverite razpoložljivost'.",
	'thanks' => 'Hvala za vpis!',
	'sign in no approval' => 'Če ste izbrali skupino, ki ne zahteva odobritve s strani administratorja, se lahko vpišete že zdaj <a href=index.php?signIn=1>tukaj</a>.',
	'sign in wait approval' => 'Če ste izbrali skupino, ki zahteva administratorjevo odobritev, prosimo počakajte e-pošto s potrditvijo odobritve.',
	'username empty' => 'Morate navesti uporabniško ime. Prosimo, da se vrnete in vpišite uporabniško ime',
	'password invalid' => 'Morate navesti geslo z najmanj 4 znaki, brez presledkov. Prosimo, da se vrnete in vpišete veljavno geslo',
	'password no match' => 'Gesli se ne ujemata. Vrnite se in popravite geslo',
	'username exists' => 'Uporabniško ime že obstaja. Prosimo, da se vrnete in izberete drugačno uporabniško ime.',
	'email invalid' => 'Neveljavna elektronska pošta. Prosimo, da se vrnete in popravite vašo elektronsko pošto.',
	'group invalid' => 'Neveljavna skupina. Prosimo, da se vrnete in izberete veljavno skupino.',
	'sign up here' => 'Vpišite se tu!',
	'registered? sign in' => 'Že registrirani? <a href=index.php?signIn=1>Vpišite se tu</a>.',
	'sign up disabled' => 'Oprostite! Vpisovanje je trenutno omogočeno s strani administratorja. Poskusite ponovno pozneje.',
	'groups *' => 'Če izberete vpis v skupino označeno z (*), se ne boste mogli vpisati dokler ne bo administrator vaš vpis odobril. Prejeli boste elektronsko pošto z obvestilom o vpisu.',
	'sign up' => 'Vpis',
	'password reset' => 'Stran za ponastavitev gesla',
	'password reset details' => 'Vpišite uporabniško ime ali email naslov in poslali vam bomo posebno povezavo. Po kliku na to povezavo boste lahko določili vaše novo geslo.',
	'password reset subject' => 'Navodila za ponastavitev gesla',
	'password reset message' => "Dragi član, \n Če ste zahtevali ponastavitev/spremembo vašega gesla vas prosimo, da klinete na to povezavo: \n <ResetLink> \n\n Če spremembe vašega gesla niste zahtevali vi vas prosimo, da ignorirate to sporočilo. \n\n Lep pozdrav.",
	'password reset ready' => 'Elektronsko sporočilo z navodili za ponastavitev gesla je bilo poslano na vaš registriran email naslov. Prosimo, pustite to okno odprto in sledite navodilom v elektronskem sporočilu.<br><br>Če ne prejmete sporočila v roku 5 minut, poskusite izvesti funkcijo ponastavitve gesla ponovno in preverite, da ste vaš email naslov vnesli pravilno.',
	'password reset invalid' => 'Napačno uporabniško ime ali geslo. <a href=membership_passwordReset.php>Poskusite znova</a>, ali se vrnite nazaj <a href=index.php>na vstopno stran</a>.',
	'password change' => 'Stran za zamenjavo gesla',
	'new password' => 'Novo geslo',
	'password reset done' => 'Vaše geslo je bilo uspešno spremenjeno. Zdaj se lahko ponovno <a href=index.php?signOut=1>prijavite z novim geslom</a>.',
	'Loading ...' => 'Nalagam ...',
	'No records found' => 'Ni zapisov',
	'You can add children records after saving the main record first' => 'Podzapise lahko dodajate šele, ko shranite glavni zapis',
	...
	'Edit' => 'Urejanje',
	'View' => 'Pogled',
	'Only your own records' => 'Samo svoje zapise',
	'All records owned by your group' => 'Vsi zapisi, ki pripadajo skupini',
	...
	'Update password' => 'Posodobite geslo',
	'Change your password' => 'Spremenite geslo',
	'Old password' => 'Staro geslo',
	'Password strength: weak' => 'Kompleksnost gesla: slaba',
	'Password strength: good' => 'Kompleksnost gesla: dobra',
	'Password strength: strong' => 'Kompleksnost gesla: močna',
	'Wrong password' => 'Napačno geslo',
	'Your profile was updated successfully' => 'Vaš provil je bil uspešno posodobljen',
	'Your password was changed successfully' => 'Vaše geslo je bilo uspešno spremenjeno',
	'Your IP address' => 'Vaša IP številka',
	'Jump to' => 'Skoči do ...',
	'check username availability' => 'Preverite, če je uporabniško ime prosto',
