...
$Translation = [
	...
	'no' => 'Nem',
	'group' => 'Csoport',
	'check availability' => 'Ellenörzés',
	'password' => 'Jelszó',
	'confirm password' => 'jelszó mégegyszer',
	'email' => 'Emailcím',
	'ok' => 'Ok',
	'username' => 'Felhasználónév',
	'delete record' => 'Törlés',
	'select a table' => 'Ugrás ...',
	'quick search' => 'Gyorskeresés',
	'records x to y of z' => 'Adatok <FirstRecord> - <LastRecord> / <RecordCount>',
	'filters' => 'Szûrõk',
	'filter' => 'Szûrõ',
	'filtered field' => 'szûrt mezõ',
	'comparison operator' => 'Reláció',
	'comparison value' => 'Összehasonlított érték',
	'and' => 'És',
	'or' => 'Vagy',
	'equal to' => 'Egyenlõ',
	'not equal to' => 'Nem egyenlõ',
	'greater than' => 'Nagyobb',
	'greater than or equal to' => 'Nagyobb vagy egyenlõ',
	'less than' => 'Kisebb',
	'less than or equal to' => 'Kisebb vagy egyenlõ',
	'like' => 'LIKE',
	'not like' => 'NOT LIKE',
	'is empty' => 'Üres',
	'is not empty' => 'Nem üres',
	'apply filters' => 'Szûrõk alkalmazása',
	'save filters' => 'Szûrõk alkalmazása és mentése',
	'saved filters title' => 'HTML kód az alkalmazatt szûrõhöz',
	'saved filters instructions' => 'Kód másolása és html fájlba illesztése elmentéshez, hogy késõbb újra elõhívható legyen.',
	'hide code' => 'Kód elrejtése',
	'printer friendly view' => 'Nyomtatóbarát nézet',
	'save as csv' => 'CSV fájl letöltése',
	'edit filters' => 'Szûrõk módosítása',
	'clear filters' => 'Szûrõk clear',
	'order by' => 'Rendezés',
	'go to page' => 'Lapra ugrás:',
	'none' => 'Nincs',
	'are you sure?' => 'Biztosan törölni szeretnéd ezt a bejegyzést?',
	'add new record' => 'Új bejegyzés felvitele',
	'update record' => 'Frissités',
	'deselect record' => 'Kiválasztás törlése',
	"couldn't delete" => "Nem törölhetõ a bejegyzés, kapcsódó '<TableName>' / <RelatedRecords> eleme miatt",
	'confirm delete' => "Ez az elem <RelatedRecords> kapcsolódik a '<TableName>' táblához. Biztosan törölni szeretnéd? <Törlés> &nbsp; <Mégsem>",
	'yes' => 'Igen',
	'pkfield empty' => ' Ez a mezõ elsõdleges kulcs, nem lehet törölni.',
	'upload image' => 'Új fájl feltöltése ',
	'select image' => 'Válassz képet ',
	'remove image' => 'Fájl eltávolítása',
	'month names' => 'Január,Február,Marcius,Április,Május,Június,Julius,Augusztus,Szeptember,Október,November,December',
	'field not null' => 'Kötelezõ adat.',
	'*' => '*',
	'today' => 'Ma',
	'homepage' => 'Kezdõlap',
	'error:' => 'Hiba:',
	...
	'query:' => 'Lekérdezés:',
	'< back' => '&lt; Vissza',
	"if you haven't set up" => "Ha még nincs adatbázis beállítva, most megteheted <a href='setup.php'>klikk ide</a>.",
	'file too large' => 'Hiba: A fájl mérete meghaladja a megengedett <MaxSize> KB-t',
	'invalid file type' => 'Hiba: nem megengedett fájl. Csak <FileTypes> tölthetõ fel',
	'goto start page' => 'Vissza a kezdõlapra',
	'no db connection' => 'Adatbázis kapcsolat nem létesíthetõ.',
	'no db name' => "A '<DBName>' adatbázis nem elérhetõ a szerveren.",
	'provide connection data' => 'A következõ adatok megadása szükséges az adatbázis kapcsolathoz',
	'mysql server' => 'MySQL szerver (host)',
	'mysql username' => 'MySQL Felhasználónév',
	'mysql password' => 'MySQL Jelszó',
	'mysql db' => 'Adatbázis név',
	'connect' => 'Kapcsolat',
	'setup performed' => 'Beállítás már megtörtént',
	'delete md5' => "Ha a újra szeretnéd futattni a beállításokat, töröld a 'setup.md5' fájlt a könyvtárból.",
	'table exists' => '<b><TableName></b> tábla létezik, <NumRecords> rekordot tartalmaz.',
	'failed' => 'sikertelen',
	'mysql said' => 'MySQL üzenete:',
	'table uptodate' => 'Tábla friss.',
	'couldnt count' => '<b><TableName></b> tábla rekordjainak megszámlálása sikertelen',
	'creating table' => '<b><TableName></b> tábla létrehozása... ',
	'tableAccessDenied' => 'Nincs jogosultságod a tábla elérésére. Keresd az adminisztrátort.',
	'not signed in' => 'Nem vagy belépve',
	'sign in' => 'Bejelentkezés',
	'signed as' => 'Belépve mint',
	'admin setup needed' => 'Adminisztrációs beállítások még nem lettek futtava. Lépj be <a href=admin/>adminisztrációs terület</a>re a beállításhoz.',
	'db setup needed' => 'Program beállítások még nem lettek futtava. Lépj be <a href=setup.php>beáálítások</a> menübe.',
	'login failed' => 'Az elõzõ belépés hibás. Próbáld újra.',
	'sign in here' => 'Belépés',
	'go to signup' => 'Nincs még felhasználóneve? <br>&nbsp; <a href=membership_signup.php>Regisztrálj itt</a>',
	'forgot password' => 'Elfelejtett jelszó? <a href=membership_passwordReset.php>Klikk ide</a>',
	'browse as guest' => 'vagy <a href=index.php>klikk ide</a> <br>&nbsp; böngészés vendégként.',
	'no table access' => 'Nincs megfelelõ jogosultságod. Lépj be elõször.',
	'user already exists' => "A '<MemberID>' felhasználónév már létezik. Válassz másikat.",
	'user available' => "A '<MemberID>' felhasználónév használható.",
	'empty user' => "Add meg a kívánt felhasználónevet és klikkelj az 'Ellenõrzés'-*re.",
	'thanks' => 'Köszönjük a regisztrációt!',
	'sign in no approval' => 'Ha olyan csoportot választottál ami nem kíván engedélyezést, itt <a href=index.php?signIn=1>beléphetsz</a>.',
	'sign in wait approval' => 'Ha olyan csoportot választottál ami engedélyezést kíván, várj emailben visszajelzést az adminisztrátortól.',
	'username empty' => 'Felhasználónév megadása kötelezõ. Javítsd.',
	'password invalid' => 'A jelszó mi 4 karakter, szóköz nélkül. Javítsd.',
	'password no match' => 'A jelszó ellenörzés hibás. Javítsd.',
	'username exists' => 'felhasználónév már létezik. Válassz egy másik felhasználónevet.',
	'email invalid' => 'Hibás emailcím. Javítsd a címet.',
	'group invalid' => 'Hibás csoport. Válassz új csoportot.',
	'sign up here' => 'Regisztrálj itt!',
	'registered? sign in' => 'Már regisztrált? <a href=index.php?signIn=1>Belépés</a>.',
	'sign up disabled' => 'Sajnos a regisztráció átmenetileg nem engedélyezett. Próbáld késõbb.',
	'groups *' => 'Ha jelölt (*) csoportot választása esetén, belépés csak adminisztrátori engedélyezés után lehetséges. Az engedélyezésrõl email értesítést küld a rendszer.',
	'sign up' => 'Regisztráció',
	'password reset' => 'jelszó változtatás',
	'password reset details' => 'Add meg a felhasználóneved és emailcímed. Emaiben küldünk egy hívatkozást, arra kattintva lehetséges új jelszót beállítani.',
	'password reset subject' => 'jelszó változtatás instrukciók',
	'password reset message' => "Kedves Felhasználó, \n Kérésedre az alábbi hívatkozásra kattintva megváltoztathatod jelszavad, Klikk az alábbi hívatkozásra: \n <ResetLink> \n\n Ha nem kérvényezted, hagyd figyelmen kívül ezt a levelet. \n\n Regards.",
	'password reset ready' => 'A rendszer egy automatikus email üzenetet küldött a regisztrált emaicímre. Kövesd az email utasítását a jelszó megváltoztatásához.<br><br>Ha az email nem érkezne meg 5 percen belül, próbáld újra ill ellenõrízd a felhasználónevet és emailcímet.',
	'password reset invalid' => 'Hibás kulcs. <a href=membership_passwordReset.php>Próbáld újra</a>, vagy vissza a <a href=index.php>kezdõlapra</a>.',
	'password change' => 'Jelszó megváltoztatása',
	'new password' => 'Új jelszó',
	'password reset done' => 'A jelszóváltoztatás sikeres volt. Az új jelszóval <a href=index.php?signOut=1>itt léphetsz be</a>.',
	'Jump to' => 'Ugrás ...',
	'check username availability' => 'Ellenörzés',
