...
$Translation = [
	...
	'no' => 'Nu',
	'group' => 'Grup',
	'check availability' => 'Verificati daca acest nume de utilizator este disponibil',
	'password' => 'Parola',
	'confirm password' => 'Confirma parola',
	'email' => 'Adresa Email',
	'ok' => 'Trimite',
	'username' => 'Utilizator',
	'delete record' => 'Sterge inregistrare',
	'select a table' => 'Salt la...',
	'quick search' => 'Cautare rapida',
	'records x to y of z' => 'Inregistrari de la <FirstRecord> la <LastRecord> din <RecordCount>',
	'filters' => 'Filtre',
	'filter' => 'Filtru',
	'filtered field' => 'Campuri filtrate',
	'comparison operator' => 'Operator de comparatie',
	'comparison value' => 'Valoare comparatie',
	'and' => 'Si',
	'or' => 'Sau',
	'equal to' => 'Egal cu',
	...
	'less than or equal to' => 'Mai putin sau egal cu',
	'like' => 'Asemanator cu',
	'not like' => 'Neasemanator cu',
	'is empty' => 'Este gol',
	'is not empty' => 'Nu este gol',
	'apply filters' => 'Aplica filtrele',
	'save filters' => 'Salveaza si aplica filtrele',
	'saved filters title' => 'Codul HTML pentru filtrele aplicate',
	'saved filters instructions' => 'Copiati codul de mai jos si inserati-l intr-un fisier HTML pentru a salva filtrul pe care l-ati definit astfel incat sa puteti reveni la el in orice moment in viitor fara a fi nevoie sa il redefiniti. Puteti salva acest cod HTML in calculator sau pe server si sa accesati direct aceasta varianta prefiltrata.',
	'hide code' => 'Ascunde acest cod',
	'printer friendly view' => 'Vizualizare tiparire',
	'save as csv' => 'Descarcare ca fisier csv (valori separate prin virgula)',
	'edit filters' => 'Editeaza filtre',
	'clear filters' => 'Sterge filtre',
	'order by' => 'Ordoneaza dupa',
	'go to page' => 'Mergi la pagina:',
	'none' => 'Nimic',
	'Select all records' => 'Selectati toate inregistraile',
	'With selected records' => 'Cu inregistrarile selectate',
	'Print Preview Detail View' => 'Previzualizare tiparire Vizualizare detaliu',
	'Print Preview Table View' => 'Previzualizare tiparire Vizualizare tabel',
	'Print' => 'Tiparire',
	'Cancel Printing' => 'Anulare tiparire',
	'Cancel Selection' => 'Anulare selectie',
	'Maximum records allowed to enable this feature is' => 'Numarul maxim de inregistrari permise pentru a activa acesta caracteristica',
	'No matches found!' => 'Fara rezultat!',
	'Start typing to get suggestions' => 'Incepeti sa tastati pentru a obtine sugestii.',
	'are you sure?' => 'Sunteti sigur ca doriti sa stergeti aceasta inregistrare?',
	'add new record' => 'Adauga o noua inregistrare',
	'update record' => 'Actualizare inregistrare',
	'deselect record' => 'Deselecteaza inregistrare',
	"couldn't delete" => 'Nu am putut sterge aceasta inregistrare datorita prezentei inregistrarii(lor) <RelatedRecords> in tabelul [<TableName>]',
	'confirm delete' => 'Aceasta inregistrare <RelatedRecords> are inregistrari referitoare in table [<TableName>]. Mai doriti sa stergeti? <Delete> &nbsp; <Cancel>',
	'yes' => 'Da',
	'pkfield empty' => ' campul este cheie primara si nu poate fi gol.',
	'upload image' => 'Incarca un fisier nou ',
	'select image' => 'Selecteaza o imagine ',
	'remove image' => 'Elimina fisier',
	'month names' => 'Ianuarie,Februarie,Martie,Aprilie,Mai,Iunie,Iulie,August,Septembrie,Octombrie,Noiembrie,Decembrie',
	'field not null' => 'Nu puteti lasa acest camp gol.',
	'*' => '*',
	'today' => 'Astazi',
	'Hold CTRL key to select multiple items from the above list.' => 'Tineti apasata tasta CTRL pentru a selecta mai multe elemente din lista de mai sus.',
	'Save New' => 'Salveaza',
	'Save As Copy' => 'Salveaza ca duplicat',
	'Deselect' => 'Anuleaza',
	'Add New' => 'Adauga nou',
	'Delete' => 'Sterge',
	'Cancel' => 'Anuleaza',
	'Print Preview' => 'Previzualizare tiparire',
	'Save Changes' => 'Salveaza modificarile',
	'CSV' => 'Salveaza CSV',
	'Reset Filters' => 'Arata tot',
	'Find It' => 'Cauta	',
	'Previous' => 'Anterior',
	'Next' => 'Urmator',
	'Back' => 'Inapoi',
	...
	'query:' => 'Interogare:',
	'< back' => 'Inapoi',
	"if you haven't set up" => "Daca nu ati configurat baza de date inca, puteti face acest lucru facand clic <a href='setup.php'>aici</a>.",
	'file too large' => 'Eroare: Fisierul incarcat depaseste dimensiunea maxima permisa de <MaxSize> KB',
	'invalid file type' => 'Eroare: Acest tip de fisier nu este permis. Doar fisiere <FileTypes> pot fi incarcate',
	'goto start page' => 'Inapoi la pagina de start',
	'no db connection' => 'Nu s-a putut stabili o conexiune cu baza de date.',
	'no db name' => "Nu s-a putut accesa baza de date cu numele '<DBName>' de pe acest server.",
	'provide connection data' => 'Va rugam sa furnizati urmatoarele date pentru conectarea la baza de date:',
	'mysql server' => 'MySQL server (gazda)',
	'mysql username' => 'Utilizator MySQL',
	'mysql password' => 'Parola MySQL',
	'mysql db' => 'Numele bazei de date',
	'connect' => 'Conexiune',
	'setup performed' => 'Instalarea a fost efectuata deja',
	'delete md5' => "Daca doriti sa fortati instalarea sa ruleze din nou, trebuie sa stergeti mai intai fisierul 'setup.md5' din acest folder.",
	'table exists' => 'Tabelul <b><TableName></b> exista, continand <NumRecords> inregistrari.',
	'failed' => 'Nu a reusit',
	'mysql said' => 'MySQL spune:',
	'table uptodate' => 'Tabelul este actualizat.',
	'couldnt count' => 'Nu s-au putut numara inregistrarile tabelului <b><TableName></b>',
	'creating table' => 'Creare tabel <b><TableName></b> ... ',
	'tableAccessDenied' => 'Imi pare rau! Nu aveti permisiunea de a accesa acest tabel. Va rugam sa contactati administratorul.',
	'not signed in' => 'Nu sunteti autentificati',
	'sign in' => 'Autentificati-va',
	'signed as' => 'Autentificat ca',
	'admin setup needed' => 'Configurarea pentru Admin nu a fost realizata. Conectati-va in <a href=admin/>panoul de control al adminului</a> pentru a efectua configurarea.',
	'db setup needed' => 'Configurarea programului nu a fost realizata inca. Conectati-va in <a href=setup.php>pagina de configurare</a> intai.',
	'new record saved' => 'Noua inregistrare a fost salvata cu succes.',
	'record updated' => 'Modificarile au fost salvate cu succes.',
	'login failed' => 'Incercarea de autentificare anterioara nu a reusit. Incercati din nou.',
	'sign in here' => 'Inscrie-te aici',
	'remember me' => 'Tine-ma minte',
	'go to signup' => 'Nu aveti un nume de utilizator? <br>&nbsp; <a href=membership_signup.php>Inscrie-te aici</a>',
	'forgot password' => 'Ai uitat parola? <a href=membership_passwordReset.php>Apasa aici</a>',
	'browse as guest' => '<a href=index.php>Continua navigarea ca utilizator neinregistrat</a>',
	'no table access' => 'Nu aveti suficiente permisiuni pentru a accesa orice pagina aici. Va rugam sa va autentificati.',
	'signup' => 'Inscrie-te',
	'user already exists' => "Utilizatorul '<MemberID>' exista deja. Incercati alt nume de utilizator.",
	'user available' => "Utilizatorul '<MemberID>' este disponibil si puteti sa il folositi.",
	'empty user' => "Va rugam sa introduceti un nume de utilizator in caseta, apoi faceti clic pe 'Verifica disponibilitate'.",
	'thanks' => 'Va multumim pentru inscriere!',
	'sign in no approval' => 'Daca ati ales un grup care nu are nevoie de aprobarea administratorului, puteti sa va conectati acum <a href=index.php?signIn=1>aici</a>.',
	'sign in wait approval' => 'Daca ati ales un grup, care necesita aprobarea administratorului, va rugam sa asteptati un e-mail de confirmare pentru aprobare.',
	'username empty' => 'Trebuie sa furnizati un nume de utilizator. Va rugam sa mergeti inapoi si sa introduceti un nume de utilizator',
	'password invalid' => 'Trebuie sa furnizati o parola de 4 caractere sau mai multe, fara spatii. Va rugam sa mergeti inapoi si sa introduceti parola valida',
	'password no match' => 'Parola nu se potriveste. Va rugam sa mergeti inapoi si sa corectati parola',
	'username exists' => 'Numele de utilizator exista deja. Va rugam sa mergeti inapoi si sa alegeti un nume de utilizator diferit.',
	'email invalid' => 'Adresa de e-mail nevalida. Va rugam sa mergeti inapoi si sa corectati adresa de e-mail.',
	'group invalid' => 'Grup invalid. Va rugam sa mergeti inapoi si sa corectati selectia de grup.',
	'sign up here' => 'Inscrie-te aici!',
	'registered? sign in' => 'Deja inregistrat? <a href=index.php?signIn=1>Autentifica-te aici</a>.',
	'sign up disabled' => 'Ne pare rau! Inscrierea este dezactivata temporar de administrator. Incercati din nou mai tarziu.',
	'groups *' => 'Daca alegeti sa va inscrieti la un grup marcat cu asterisc (*), nu veti putea sa va autentificati pana cand administratorul nu aproba. Veti primi un e-mail atunci cand primiti aprobarea.',
	'sign up' => 'Inscrie-te',
	'password reset' => 'Pagina pentru resetarea parolei',
	'password reset details' => 'Introduceti numele de utilizator sau adresa de email mai jos. Vom trimite apoi un link special pe adresa dvs. de email. Dupa ce faceti clic pe link, vi se va cere sa introduceti o noua parola.',
	'password reset subject' => 'Instructiuni pentru resetarea parolei',
	'password reset message' => "Stimate membru, \n Daca ati solicitat pentru a reseta / schimba parola, va rugam sa faceti clic pe acest link: \n <ResetLink> \n\n Dac? nu ati solicitat o resetare a parolei / schimbare, va rugam sa ignorati acest mesaj. \n\n Multumim.",
	'password reset ready' => 'Un e-mail cu instructiuni de resetare a parolei a fost trimis la adresa de email inregistrata.Va rugam sa urmati instructiunile din acest mesaj de e-mail.<br><br>Daca nu primiti acest e-mail in termen de 5 minute, incercati sa resetati din nou parola si asigurati-va ca ati introdus un nume de utilizator corect sau adresa de email.',
	'password reset invalid' => 'Utilizator invalid sau parola invalida. <a href=membership_passwordReset.php>Incercati din nou</a>, sau clic <a href=index.php>inapoi la pagina principala</a>.',
	'password change' => 'Pagina de schimbare a parolei',
	'new password' => 'Parola noua',
	'password reset done' => 'Parola dvs. a fost schimbata cu succes. Puteti sa va<a href=index.php?signOut=1>autentificati cu noua parola aici</a>.',
	'Loading ...' => 'Incarcare ...',
	'No records found' => 'Nu exista inregistrari',
	'You can add children records after saving the main record first' => 'Puteti adauga inregistrari copil dupa salvarea inregistrarii principale intai',
	'ascending' => 'Ascendent',
	...
	'Edit' => 'Editare',
	'View' => 'Vizualizare',
	'Only your own records' => 'Numai inregistrarile dvs',
	'All records owned by your group' => 'Toate inregistrarile detinute de grupul dvs.',
	'All records' => 'Toate inregistrarile',
	'Not allowed' => 'Nu este permis',
	'Your info' => 'Informatiile dvs.',
	'Hello user' => 'Salut %s!',
	'Your access permissions' => 'Permisiuni de acces',
	'Update profile' => 'Actualizare profil',
	'Update password' => 'Actualizare parola',
	'Change your password' => 'Modifica-ti parola',
	'Old password' => 'Parola veche',
	'Password strength: weak' => 'Intensitate parola: slaba',
	'Password strength: good' => 'Intensitate parola: buna',
	'Password strength: strong' => 'Intensitate parola: puternica',
	'Wrong password' => 'Parola gresita',
	'Your profile was updated successfully' => 'Profilul dvs. a fost actualizat cu succes',
	'Your password was changed successfully' => 'Parola dvs. a fost schimbata cu succes',
	'Your IP address' => 'Adresa IP a dvs.',
	'Records to display' => 'Inregistrari pentru afisare',
	'Setup Data' => 'Data instalarii',
	'Database Information' => 'Informatii despre baza de date',
	'Admin Information' => 'Informatii despre administrator',
	'setup intro 1' => 'Nu pare sa existe un fisier de configurare. Acest lucru este necesar pentru aplicarea la locul de munca.<br><br>Aceasta pagina de configurare va va ajuta sa creati acel fisier. Dar in unele configuratii de server acest lucru ar putea sa nu functioneze. In acest caz, s-ar putea sa fie nevoie de a ajusta permisiunile de folder, sau sa creati manual fisierul de configurare.',
	'setup intro 2' => 'Bine ati venit la noua dvs. aplicatie AppGini! Inainte de a incepe, avem nevoie de cateva informatii despre baza de date. Veti avea nevoie sa stiti urmatoarele inainte de a incepe:<ol><li>Serverul bazei de date(gazda)</li><li>Numele bazei de date</li><li>Utilizatorul bazei de date</li><li>Parola bazei de date</li></ol>Elementele de mai sus au fost, probabil, furnizate de catre furnizorul dvs. de gazduire web.Daca nu aveti aceste informatii, atunci va trebui sa-i contactati sau consultati documentatia oferita de ei, inainte de a putea continua aici.Daca sunteti gata, sa incepem!',
	'setup finished' => '<b>Success!</b><br><br>Aplicatia dvs. AppGini a fost instalata. Iata cateva sugestii pentru a incepe utilizarea acestuia:',
	'setup next 1' => 'Incepeti sa utilizati aplicatia pentru a adauga date, sau sa lucreze cu datele existente, dac? este cazul.',
	'setup next 2' => 'Importul datelor existente in aplicatia dumneavoastra dintr-un fisier CSV.',
	'setup next 3' => 'Du-te la pagina de administrare unde puteti schimba multe alte setari ale aplicatiei.',
	'db_name help' => 'Numele bazei de date pe care doriti sa o rulati aplicatia AppGini.',
	'db_server help' => '<i>localhost</i> merge pe majoritatea serverelor. Daca nu, ar trebui sa obtineti aceste informatii de la furnizorul dvs. de g?zduire web.',
	'db_username help' => 'Utilizatorul MySQL',
	'db_password help' => 'Parola MySQL',
	'username help' => 'Specificati numele de utilizator de administrator pe care doriti sa-l utilizati pentru a accesa zona de administrare. Trebuie sa fie de patru caractere sau mai multe.',
	'password help' => 'Specificati o parola puternica pentru a accesa zona de administrare.',
	'email help' => 'Introduceti adresa de e-mail unde doriti ca notificarile de administrare sa fie trimise.',
	'Continue' => 'Continuare ...',
	'Lets go' => 'Sa mergem!',
	'Submit' => 'Trimite',
	'Hide' => 'Inchide ajutor',
	'Database info is correct' => '&#10003; Informatiile bazei de date sunt corecte!',
	'Database connection error' => '&#10007; Eroare la conexiunea cu baza de date!',
	'The following errors occured' => 'Urmatoarele erori au aparut',
	'failed to create config instructions' => 'Acest lucru este cel mai probabil din cauza permisiuni de folder, care sunt stabilite pentru a preveni crearea de fisiere de catre serverul de web.Nu va faceti griji! Puteti crea fisierul de config manual.<br><br>Doar inserati codul de mai jos intr-un editor de text si salvati fisierul ca denumire "config.php", apoi incarcati-l folosind FTP sau orice alta metoda in folderul %s de pe serverul dvs.',
	'Only show records having filterer' => 'Arata inregistrarile unde %s este %s',
	"You don't have enough permissions to delete this record" => 'Nu aveti suficiente permisiuni pentru a sterge acesta inregistrare',
	"Couldn't delete this record" => 'Aceasta inregistrare nu a putut fi stearsa',
	'The record has been deleted successfully' => 'Inregistrarea a fost stearsa cu succes',
	"Couldn't save changes to the record" => 'Modificarile inregistrarii nu au fost salvate',
	"Couldn't save the new record" => 'Noua inregistrare nu a putut fi salvata',
	'Jump to' => 'Salt la...',
	'check username availability' => 'Verificati daca acest nume de utilizator este disponibil',
