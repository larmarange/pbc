...
$Translation = [
	...
	'no' => 'Nie',
	'group' => 'Skupina',
	'check availability' => 'Zkontrolovat či ide pouzít toto uziivatelské méno',
	'password' => 'Heslo',
	'confirm password' => 'Potvrdit heslo',
	'email' => 'Emailová adresa',
	'ok' => 'Ok',
	'username' => 'Uzivatelské meno',
	'delete record' => 'Zmazat záznam',
	'select a table' => 'Prejst na ...',
	'quick search' => 'Rychlé hladaníe',
	'records x to y of z' => 'Záznamy <FirstRecord>  az  <LastRecord> z <RecordCount>',
	'filters' => 'Filtry',
	'filter' => 'Filter',
	'filtered field' => 'Filtrované pole',
	'comparison operator' => 'Porovnávací operátor',
	'comparison value' => 'Porovnávaná hodnota',
	'and' => 'A',
	'or' => 'Lebo',
	'equal to' => 'Rovna sa',
	'not equal to' => 'Není rovnake',
	'greater than' => 'Většíe než',
	'greater than or equal to' => 'Vatšíe Lebo rovnake',
	'less than' => 'Menšíe než',
	'less than or equal to' => 'Menšíe lebo rovnake',
	'like' => 'Ako',
	'not like' => 'Není ako',
	'is empty' => 'Je prázdné',
	...
	'saved filters instructions' => 'Zkopírujte nížšie uvedený kód a vložte ho do HTML souboru pro uloženíe Vámi právě definovaného filtru. V budoucnosti sa k nemu budete moci hodcikedy vrátit bez nutnosti jeho definovánía. Tento HTML kód možete uložit na svoj počítač lebo na hodciktorý server zpřístupnit cez neho filtrovaný tabulkový pohled.',
	'hide code' => 'Skrýt tento kód',
	'printer friendly view' => 'Tiskový náhlad',
	'save as csv' => 'Stiahnout ako subor csv (hodnoty oddelené čiarkami)',
	'edit filters' => 'Úprava filtrov',
	'clear filters' => 'Smazáníe filtrov',
	'order by' => 'řiadit podla',
	'go to page' => 'Prejst na stránku:',
	'none' => 'Nic',
	'are you sure?' => 'Opravdu smazat tento záznam?',
	'add new record' => 'Přidat nový záznam',
	'update record' => 'Aktualizovat záznam',
	'deselect record' => 'Odznačit záznam',
	"couldn't delete" => "Nejde vyazat záznam, z dovodu výskytu <RelatedRecords> souvisejucích záznamov v tabulke '<TableName>'",
	'confirm delete' => "Záznam má <RelatedRecords> souvisujíce záznamy v tabulke '<TableName>'. Opravdu ich zmazat? <Delete> &nbsp; <Cancel>",
	'yes' => 'Ano',
	'pkfield empty' => ' pole je primárním klíčom, preto nemože být prázdné.',
	'upload image' => 'Nahrát nový soubor ',
	'select image' => 'Vybrat obrázok ',
	'remove image' => 'Odstranit subor',
	'month names' => 'Januar,Februar,Marec,April,Maj,Jún,Júl,Agust,September,Oktober,November,December',
	'field not null' => ' musí být vyplnené.',
	'*' => '*',
	'today' => 'Dnes',
	'homepage' => 'Hlavna stránka',
	'error:' => 'Chyba:',
	'sql error:' => 'SQL chyba:',
	'query:' => 'Dotaz:',
	'< back' => 'Ist Zpat',
	"if you haven't set up" => "Pokial ešte nemáte nastavenu databázu, možete to previest kliknutím <a href='setup.php'>zde</a>.",
	'file too large' => 'Chyba: Soubor, který jste nahral prevyšuje maximálnu povolenu velkost <MaxSize> KB',
	'invalid file type' => 'Chyba: Tento typ souboru není povolen. Iba soubory typu <FileTypes> možu být nahráne',
	'goto start page' => 'Zpět na hlavnu stránku',
	'no db connection' => 'Nejde naviazat spojeníe s databázou.',
	'no db name' => "Nejde zpřístupnit databázu '<DBName>' na tomto serveru.",
	'provide connection data' => 'Zadajte následujuce data pre přístup k databáze:',
	'mysql server' => 'MySQL server (host)',
	'mysql username' => 'MySQL uživatelské méno',
	'mysql password' => 'MySQL heslo',
	'mysql db' => 'Názov databázy',
	'connect' => 'Pripojit',
	'setup performed' => 'Nastavenie už vykonane',
	'delete md5' => "Pokial chcete urychlit nastaveníe pri buducom spusteníu, zmažte subor 'setup.md5' v tomto adresári.",
	'table exists' => 'Tabulka <b><TableName></b> existuje, obsahuje <NumRecords> záznamů.',
	'failed' => 'Zlihalo',
	'mysql said' => 'MySQL hlasi',
	'table uptodate' => 'Tabulka je aktuálna.',
	'couldnt count' => 'Nejd spočítat záznamy v tabulke <b><TableName></b>',
	'creating table' => 'Vytváreníe tabulky <b><TableName></b> ... ',
	'tableAccessDenied' => 'Nemáte oprávneníe pre prístup.',
	'not signed in' => 'Nie ste prihlaseny',
	'sign in' => 'Prihlásit',
	'signed as' => 'Prihlasený uživatel',
	'admin setup needed' => 'Nastaveníe zprávca nebolo provedene. Prihlaste sa, prosím, do <a href=admin/>sekce pre správu</a> pre prevedenía nastavení.',
	'db setup needed' => 'Nastaveníe programu ešte nebolo prevedene. Nejprv sa prihlaste na <a href=setup.php>stránke nastavení</a>.',
	'login failed' => 'Váš; posledny pokus o prihlasenie zlihal. Zkuste to znova.',
	'sign in here' => 'Prihlásenie',
	'go to signup' => 'Registrace <br>&nbsp; <a href=membership_signup.php>Registrujte se zde.</a>',
	'browse as guest' => 'Nebo <a href=index.php>Klikněte zde</a> pro <br>&nbsp; prohlí&#382;ení v re&#382;imu náv&scaron;těvník.',
	'no table access' => 'Nemáte dostatečne oprávneníe pre prístup do aplikacie. Najprv sa prosím prihlaste.',
	'user already exists' => "Uživatelské méno '<MemberID>' uz existuje. Zkuste iné  jméno.",
	'user available' => "Uživatelské méno '<MemberID>' je použitelne.",
	'empty user' => "Najprv napište do pola svoje uživatelské méno a potom kliknite na 'Zkontrolovat dostupnost'.",
	'thanks' => 'Dakujeme za registraciu!',
	'sign in no approval' => 'Pokud máte vybránu skupinu, ktorá nepodléhá schváleníu správcom systému, mozete sa zaregistrovat <a href=index.php?signIn=1>zde</a>.',
	'sign in wait approval' => 'Pokud máte vybránu skupinu, která podléhá schválení správcem systému, počkajte prosím na email, potvrzující schváleníe přístupu.',
	'username empty' => 'Musíte zadat uzivatelské méno. Vratte sa prosím a zadajte svoje uzivatelské méno',
	'password invalid' => 'Mosíte zadat heslo, obsahujíce minimálně 4 znaky, bez mezer. Vratte sa prosím a zadajte platné heslo',
	'password no match' => 'Heslo nesuhlasí. Vraťte se prosím a zadajte správné heslo',
	'username exists' => 'Uzivatelské méno uz existuje. Vraťte se prosím a vyberte si iné uzivatelské jméno.',
	'email invalid' => 'Chybne zadaná emailová adresa. Vraťte se prosím a zadejte správnu emailovu adresu.',
	'group invalid' => 'Neplatná skupina. Vraťte se prosím a opravte výběr skupiny.',
	'sign up here' => 'Registracia',
	'registered? sign in' => 'Ste uz registrovány <a href=index.php?signIn=1>Prihlásit</a>.',
	'sign up disabled' => 'Prepacte, ale registracia je dočasne pozastavena správcom systému. Zkuste to neskorsie.',
	'groups *' => 'Pokial vyberete registraciu označenu hvězdičkou (*), nebudete se moci přihlásit bez souhlasu správca systému, který obdrzíte emailem.',
	'sign up' => 'Registrovat',
	'Jump to' => 'Prejst na ...',
	'check username availability' => 'Zkontrolovat či ide pouzít toto uziivatelské méno',
