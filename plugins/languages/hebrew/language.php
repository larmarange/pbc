...
$Translation = [
	'language' => 'hebrew',
	'admin area' => 'איזור אדמיניסטרטיבי',
	'sign out' => 'צא',
	...
	'clear filters' => 'בטל מסננים',
	'order by' => 'מיין לפי',
	'go to page' => 'לך לעמוד:',
	'none' => 'None',
	'Select all records' => 'בחר את כל הרשומות',
	'With selected records' => 'עם רשומות נבחרות',
	'Print Preview Detail View' => 'הדפס מבט פרטים',
	'Print Preview Table View' => 'הדפס מבט טבלאי',
	'Print' => 'הדפס',
	'Cancel Printing' => 'בטל הדפסה',
	'Cancel Selection' => 'בטל בחירה',
	'Maximum records allowed to enable this feature is' => 'Maximum records allowed to enable this feature is',
	'No matches found!' => 'לא נמצאה תוצאה!',
	'Start typing to get suggestions' => 'התחל להקליד כדי לחפש',
	'are you sure?' => 'האם למחוק רשומה זו?',
	'add new record' => 'הוסף רשומה חדשה',
	'update record' => 'עדכן רשומה',
	'deselect record' => 'בטל בחירת רשומה',
	...
	'not signed in' => 'עדיין לא נכנסת למערכת...',
	'sign in' => 'כניסה',
	'signed as' => ' מחובר כ ',
	...
	'sign in here' => 'כניסה למערכת הניהול',
	'remember me' => 'זכור אותי',
	'go to signup' => "Don't have a username? <br>&nbsp; <a href=membership_signup.php>Sign up here</a>",
	'forgot password' => 'שכחת את ססמתך? <a href=membership_passwordReset.php>לחץ כאן</a>',
	'browse as guest' => '<a href=index.php>המשך כמשתמש אורח</a>',
	...
	'sign up here' => 'טופס הרשמה למערכת',
