...
$Translation = [
	...
	'select a table' => 'Välj tabell',
	'quick search' => 'Snabbsökning',
	'records x to y of z' => 'Post <FirstRecord> till <LastRecord> av <RecordCount>',
	'filters' => 'Filter',
	'filter' => 'Filter',
	'filtered field' => 'Filtrerat fält',
	'comparison operator' => 'Jämförande typer',
	'comparison value' => 'Jämförande värde',
	'and' => 'Och',
	'or' => 'Eller',
	'equal to' => 'Lika med',
	'not equal to' => 'Inte lika med',
	'greater than' => '&gt;  än',
	'greater than or equal to' => '&gt; = med',
	'less than' => '&lt; än',
	'less than or equal to' => '&lt; eller = med',
	'like' => 'Lika',
	'not like' => 'Inte lika ',
	'apply filters' => 'Använd filter',
	'save filters' => 'Spara och använd filter',
	'saved filters title' => 'HTML kode för sparat filter',
	'saved filters instructions' => 'Kopiera koden nedenför och klistra in den inuti en HTML fil för att ta vara på filtrena du gjort så att de kan användas senare',
	'hide code' => 'Dölj denna kod',
	'printer friendly view' => 'Utskriftsvänlig version',
	'save as csv' => 'Spara som CSV fil (Kommaseparerad fil)',
	'edit filters' => 'Ändra filter',
	'clear filters' => 'Rensa filter',
	'order by' => 'Sortera efter',
	'go to page' => 'Gå till sidan:',
	'are you sure?' => 'Är du säker du vill ta bort den här posten?',
	'add new record' => 'Lägg till Ny post',
	'update record' => 'Uppdatera post',
	'deselect record' => 'Rensa fält',
	"couldn't delete" => "Posten kan inte tas bort p.g.a. att den sammanhänger med post <RelatedRecords> relaterad till post i '<TableName>'",
	'pkfield empty' => 'Fältet för Primärnyckeln - KAN inte vara tomt',
	'upload image' => 'Hämta bild för presentation ',
	...
	'field not null' => 'Fältet kan INTE vara tomt',
	'*' => '*',
	'error:' => 'FEL:',
	'sql error:' => 'SQL fel:',
	'query:' => 'Sök:',
	'< back' => '&lt; tillbaka',
	"if you haven't set up" => "Är DataBasen installerad? Om inte - Tryck <a href='setup.php'>HÄR</a>.",
	'Jump to' => 'Välj tabell',
