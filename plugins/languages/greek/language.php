...
$Translation = [
	...
	'no' => 'Όχι',
	'group' => 'Ομάδα',
	'check availability' => 'Ελέγξτε αν το όνομα χρήστη είναι διαθέσιμο',
	...
	'select a table' => 'Μετάβαση σε ...',
	'quick search' => 'Αναζήτηση',
	'records x to y of z' => 'Εγγραφές <FirstRecord> έως <LastRecord> από <RecordCount>',
	'filters' => 'Φίλτρα',
	'filter' => 'Φίλτρο',
	'filtered field' => 'Πεδίο για φιλτράρισμα',
	'comparison operator' => 'Επιλογή τελεστών',
	'comparison value' => 'Εγγραφές για φιλτράρισμα',
	'and' => 'Και',
	'or' => 'Ή',
	'equal to' => 'Ίσο με',
	'not equal to' => 'Δεν είναι ίσο με',
	'greater than' => 'Μεγαλύτερο από',
	'greater than or equal to' => 'Μεγαλύτερο ή ίσο με',
	'less than' => 'Λιγότερο από το',
	'less than or equal to' => 'Μικρότερο ή ίσο με',
	'like' => 'ίδιο',
	'not like' => 'όχι ίδιο',
	'is empty' => 'έιναι άδειο',
	'is not empty' => 'IΔεν είναι κενό',
	'apply filters' => 'Εφαρμογή φίλτρων',
	'save filters' => 'Αποθήκευση και εφαρμογή φίλτρων',
	'saved filters title' => 'HTML κώδικας για τα εφαρμοζόμενα Φίλτρα',
	'saved filters instructions' => 'Αντιγράψτε το παρακάτω κώδικα και επικολήστε τον σε ένα αρχείο HTML για να αποθηκεύσετε το φίλτρο που μόλις ορίσατε, έτσι ώστε να μπορείτε να επιστρέψετε σε αυτήν, ανά πάσα στιγμή στο μέλλον, εάν δεν χρειάζεται να το επαναπροσδιορίσουμε. Μπορείτε να αποθηκεύσετε αυτό το HTML κώδικα στον υπολογιστή σας ή σε οποιοδήποτε server και θα έχετε εναν προφιλτραρισμένο πίνακα με πρόσβαση σε αυτόν.',
	'hide code' => 'Απόκρυψη αυτού του κώδικα',
	'printer friendly view' => 'Εκτυπώσιμη μορφή',
	'save as csv' => 'Λήψη ως αρχείο CSV (Τιμές διαχωρισμένες με κόμματα)',
	'edit filters' => 'Επεξεργασία φίλτρων',
	'clear filters' => 'Χωρίς φίλτρα',
	'order by' => 'Ταξινόμηση κατά',
	'go to page' => 'Πήγαινε στη σελίδα:',
	'none' => 'Δεν υπάρχει',
	'Select all records' => 'Επιλογή όλων των εγγραφών',
	'With selected records' => 'με τις επιλεγμένες εγγραφές',
	'Print Preview Detail View' => 'Προεπισκόπιση εκτύπωσης Δείτε αναλυτικά',
	'Print Preview Table View' => 'Προεπισκόπιση εκτύπωσης Δείτε τον πίνακα',
	'Print' => 'Προεπισκόπιση',
	'Cancel Printing' => 'Ακύρωση εκτύπωσης',
	'Cancel Selection' => 'Ακύρωση επιλογής',
	'Maximum records allowed to enable this feature is' => 'Μέγιστο επιτρεπόμενο πλήθος εγγραφών για να ενεργοποιήσετε αυτό το χαρακτηριστικό είναι',
	'No matches found!' => 'Δεν βρέθηκαν αποτελέσματα!',
	'Start typing to get suggestions' => 'Πληκτρολογήστε τιμές και θα αρχίσουν μα εμφανίζονται εγγραφές. Επιλέξτε αυτήν που θέλετε.',
	'are you sure?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το αρχείο;',
	'add new record' => 'Προσθήκη νέας εγγραφής',
	'update record' => 'Ενημέρωση εγγραφής',
	'deselect record' => 'αποεπιλογή εγγραφής',
	"couldn't delete" => "Δεν ήταν δυνατή η διαγραφή της εγγραφής λόγω της παρουσίας <RelatedRecords> σχετίζονται εγγραφή (ες) στον πίνακα«΄'<TableName>'",
	'confirm delete' => 'Αυτό το αρχείο έχει σχέση με την/τις <RelatedRecords> εγγραφή(ες) στον πίνακα« <TableName>. Εάν εξακολουθείτε να θέλετε να τη διαγράψετε <DELETE> <Cancel>',
	'yes' => 'Ναι',
	'pkfield empty' => 'Φαίνεται να είναι ένα πρωτεύον κλειδί και δεν μπορεί να είναι κενό.',
	'upload image' => 'Φόρτωση αρχείου ',
	'select image' => 'Επιλέξτε μια εικόνα ',
	'remove image' => 'διαγραφή αρχείου',
	...
	'Save New' => 'Σώσε νέα',
	'Save As Copy' => 'Σώσε ένα αντίγραφο',
	'Deselect' => 'Επιστροφή',
	'Add New' => 'Νέα Εγγραφή',
	'Delete' => 'Διαγραφή',
	'Cancel' => 'ακύρωση',
	'Print Preview' => 'Προεπισκόπιση',
	'Save Changes' => 'Σώσιμο αλλαγών',
	'CSV' => 'Σώσε σαν CSV',
	...
	'error:' => 'Σφάλμα:',
	'sql error:' => 'SQL Σφάλμα:',
	'query:' => 'Ερώτημα:',
	'< back' => 'Πίσω',
	"if you haven't set up" => "Εάν δεν έχετε δημιουργήσει τη βάση δεδομένων ακόμη, μπορείτε να το κάνετε κάνοντας κλικ <a href='setup.php'>εδώ</a>.",
	'file too large' => 'Σφάλμα: Το αρχείο που φορτώσατε υπερβαίνει το μέγιστο επιτρεπόμενο μέγεθος των <MaxSize> KB',
	'invalid file type' => 'Σφάλμα: Αυτός ο τύπος αρχείου δεν επιτρέπεται. Μόνο <FileTypes> αρχεία μπορούν να φορτωθούν',
	'goto start page' => 'Επιστροφή στην αρχική σελίδα',
	'no db connection' => 'Δεν ήταν δυνατή η δημιουργία μιας σύνδεσης με τη βάση δεδομένων.',
	'no db name' => "Δεν ήταν δυνατή η πρόσβαση στη βάση δεδομένων που ονομάζεται '<DBName>' σε αυτόν το server.",
	'provide connection data' => 'Παρακαλώ δώστε τα ακόλουθα στοιχεία για να συνδεθείτε με τη βάση δεδομένων:',
	'mysql server' => 'MySQL server (host)',
	'mysql username' => 'MySQL Όνομα Χρήστη',
	'mysql password' => 'MySQL Κωδικός χρήστη',
	'mysql db' => 'Όνομα βάσης δεδομένων',
	'connect' => 'Σύνδεση',
	'setup performed' => 'Οι ρυθμίσεις ήδη έχουν πραγματοποιηθεί',
	'delete md5' => "Αν θέλετε να επαναλάβεται την εγκατάσταση, πρέπει πρώτα να σβήστε το αρχείο 'setup.md5' από αυτό το φάκελο.",
	'table exists' => 'Ο πίνακας <b><TableName></b> υπάρχει, και περιέχει <NumRecords> εγγραφές.',
	'failed' => 'Αποτυχία',
	'mysql said' => 'MySQL λέει:',
	'table uptodate' => 'Ο πίνακας είναι ενημερωμένος.',
	'couldnt count' => 'Δεν μπορούν να μετρηθούν οι εγγραφές του <b><TableName></b>',
	'creating table' => 'Δημιουργήθηκε ο πίνακας <b><TableName></b> ... ',
	'tableAccessDenied' => 'Λυπάμαι! Δεν έχετε τα απαραίτητα δικαιώματα να δείτε τις εγγραφές. Επικοινωνήστε με το διαχειριστή.',
	'not signed in' => 'Δεν είστε συνδεδεμένος',
	'sign in' => 'Συνδεθείτε',
	'signed as' => 'Συνδεθήκατε ως',
	'admin setup needed' => 'Η εγκατάσταση διαχείρισης δεν πραγματοποιήθηκε. Παρακαλώ συνδεθείτε στον <a href=admin/> πίνακα διαχείρισης</a> για την εκτέλεση της εγκατάστασης.',
	'db setup needed' => 'Εγκατάστασης του προγράμματος δεν πραγματοποιήθηκε ακόμα. Παρακαλώ συνδεθείτε στη <a href=setup.php>σελίδα εγκατάστασης</a> πρώτα.',
	'new record saved' => 'Η αποθήκευση της νέας εγγραφή έγινε επιτυχώς.',
	'record updated' => 'Οι αλλαγές έγιναν με επιτυχία.',
	'login failed' => 'Η προηγούμενη προσπάθεια σύνδεσής σας απέτυχε. Δοκιμάστε ξανά.',
	'sign in here' => 'Συνδεθείτε εδώ',
	'remember me' => 'να θυμάσαι',
	'go to signup' => 'Δεν έχετε όνομα χρήστη? <br>&nbsp; <a href=membership_signup.php>Συνδεθείτε εδώ</a>',
	'forgot password' => 'Ξεχάσατε τον κωδικό χρήστη? <a href=membership_passwordReset.php>κάντε κλικ εδώ</a>',
	'browse as guest' => 'Ή <a href=index.php>κάντε κλικ εδώ</a> για να <br>συνεχίστε σαν επισκέπτης.',
	'no table access' => 'Δεν έχετε δικαιώματα για τη σελίδα. Παρακαλώ συνδεθείτε πρώτα.',
	'signup' => 'Εγγραφή',
	'user already exists' => "Το όνομα χρήστη '<MemberID>' υπάρχει. Δοκιμάστε ένα άλλο όνομα χρήστη.",
	'user available' => "Το όνομα χρήστη '<MemberID>' είναι διαθέσιμο.",
	'empty user' => 'Πληκτρολογείστε ένα όνομα χρήστη στο πλαίσιο πρώτα, στη συνέχεια κάντε κλικ στο κουμπί «Έλεγχος διαθεσιμότητας».',
	'thanks' => 'Σας ευχαριστούμε για την εγγραφή!',
	'sign in no approval' => 'Αν έχετε επιλέξει μια ομάδα που δεν απαιτεί την έγκριση του διαχειριστή, μπορείτε να συνδεθείτε τώρα <a href=index.php?signIn=1>εδώ</a>.',
	'sign in wait approval' => 'Αν έχετε επιλέξει μια ομάδα που απαιτεί την έγκριση του διαχειριστή, παρακαλώ περιμένετε για ένα email που επιβεβαιώνει την έγκρισή σας.',
	'username empty' => 'Πρέπει να δώσετε ένα όνομα χρήστη. Παρακαλούμε επιστρέψτε και πληκτρολογήστε ένα όνομα χρήστη',
	'password invalid' => 'Πρέπει να δώσετε έναν κωδικό πρόσβασης από 4 χαρακτήρες και άνω, χωρίς κενά. Παρακαλούμε επιστρέψτε και πληκτρολογήστε έναν έγκυρο κωδικό πρόσβασης',
	'password no match' => 'Κωδικός πρόσβασης δεν ταιριάζει. Παρακαλούμε επιστρέψτε και διορθώστε το κωδικό πρόσβασης',
	'username exists' => 'Το όνομα χρήστη υπάρχει ήδη. Παρακαλούμε να επιστρέψετε και να επιλέξετε ένα διαφορετικό όνομα χρήστη.',
	'email invalid' => 'Μη έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου. Παρακαλούμε επιστρέψτε και σωστή διεύθυνση ηλεκτρονικού ταχυδρομείου σας.',
	'group invalid' => 'Ακυρη ομάδα. Παρακαλούμε επιστρέψτε και σωστή η επιλογή της ομάδας.',
	'sign up here' => 'Κάντε κλικ εδώ!',
	'registered? sign in' => 'ήδη εγγεγραμμένος? <a href=index.php?signIn=1>Κάντε κλικ εδώ</a>.',
	'sign up disabled' => 'Συγγνώμη! Η εγγραφή είναι προσωρινά εκτός λειτουργίας από το διαχειριστή. Δοκιμάστε ξανά αργότερα.',
	'groups *' => 'Εάν επιλέξετε να εγγραφείτε σε μια ομάδα που σημειώνονται με αστερίσκο (*), δεν θα είστε σε θέση να συνδεθείτε μέχρι να λάβετε την έγκριση από το διαχειριστή. Θα λάβετε ένα μήνυμα ηλεκτρονικού ταχυδρομείου όταν έχουν εγκριθεί.',
	'sign up' => 'εγγραφείτε',
	'password reset' => 'Σελίδα επαναφοράς Κωδικού Χρήστη',
	'password reset details' => 'Εισάγετε το όνομα χρήστη σας ή το email σας παρακάτω. Θα σας στείλουμε στη συνέχεια ένα ειδικό σύνδεσμο στο email σας. Αφού κάνετε κλικ στο σύνδεσμο αυτό, θα σας ζητηθεί να εισάγετε έναν νέο κωδικό πρόσβασης.',
	'password reset subject' => 'Οδηγίες επαναφοράς κωδικού πρόσβασης',
	'password reset message' => 'Αγαπητό μέλος, εάν έχετε ζητήσει να επαναφέρετε ή να αλλάξετε τον κωδικό σας, κάντε κλικ σε αυτό το σύνδεσμο: <ResetLink> ή αν δεν έχετε ζητήσει έναν κωδικό πρόσβασης επαναφορά ή αλλαγή, παρακαλούμε να αγνοήσετε αυτό το μήνυμα.',
	'password reset ready' => 'Ένα μήνυμα ηλεκτρονικού ταχυδρομείου με οδηγίες για επαναφορά του κωδικού πρόσβασης έχει σταλεί στη διεύθυνση ηλεκτρονικού ταχυδρομείου σας. Παρακαλώ κρατήστε αυτό το παράθυρο ανοιχτό και ακολουθήστε τις οδηγίες στο μήνυμα ηλεκτρονικού ταχυδρομείου. <br><br> Εάν δεν λάβετε αυτό το e-mail μέσα σε 5 λεπτά, προσπαθήστε να επαναφέρετε τον κωδικό πρόσβασής σας και πάλι, και βεβαιωθείτε ότι μπαίνετε σε ένα σωστό όνομα χρήστη ή το e-mail.',
	'password reset invalid' => 'Ακυρο κλειδί. <a href=membership_passwordReset.php>Προσπαθήστε πάλι</a>, ή πηγαίνετε <a href=index.php>πίσω στην αρχική σελίδα</a>.',
	'password change' => 'Σελίδα αλλαγής κωδικού',
	'new password' => 'Νέος κωδικός',
	'password reset done' => 'Ο κωδικός σας άλλαξε με επιτυχία. μπορείτε να <a href=index.php?signOut=1>συνδεθείτε με το νέο κωδικό πρόσβασης εδώ</a>.',
	'Loading ...' => 'φόρτωση ...',
	'No records found' => 'Δεν βρέθηκαν εγγραφές',
	'You can add children records after saving the main record first' => 'Μπορείτε να προσθέσετε εξαρτώμενες εγγραφές μετά από την αποθήκευση της κύριας εγγραφής',
	'ascending' => 'Αύξουσα',
	'descending' => 'Φθίνουσα',
	'then by' => 'Στη συνέχεια, από',
	'Legend' => 'Legend',
	'Table' => 'Πίνακας',
	'Edit' => 'Επεξεργασία',
	'View' => 'Προβολή',
	'Only your own records' => 'Μόνο τις εγγραφές σας',
	...
	'Old password' => 'Ο παλιός κωδικός σας',
	'Password strength: weak' => 'Ισχύς κωδικού πρόσβασης: αδύναμη',
	'Password strength: good' => 'Ισχύς κωδικού πρόσβασης: καλή',
	'Password strength: strong' => 'Ισχύς κωδικού πρόσβασης: δυνατή',
	'Wrong password' => 'Λάθος κωδικός',
	'Your profile was updated successfully' => 'Το προφίλ σας ενημερώθηκε επιτυχώς',
	'Your password was changed successfully' => 'Ο κωδικός σας άλλαξε με επιτυχία',
	'Your IP address' => 'Η διεύθυνση IP σας',
	'Records to display' => 'Εγγραφές για εμφάνιση',
	'Jump to' => 'Μετάβαση σε ...',
	'check username availability' => 'Ελέγξτε αν το όνομα χρήστη είναι διαθέσιμο',
