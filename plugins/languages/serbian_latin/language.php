...
$Translation = [
	...
	'no' => 'Ne',
	'group' => 'Grupa',
	'check availability' => 'Proveri da li je korisničko ime zauzeto',
	'password' => 'Šifra',
	...
	'saved filters instructions' => 'Kopiraj kod ispod i prilepi u HTML fajl da biste sačuvali filter koji ste definisali da biste mogli da se vratite na isti bilo kada u budućnosti bez potrebe za izmenama. Možete sačuvati ovaj HTML kod na Vaš kompjuter ili na bilo koji server i pristupiti ovoj unapred filtriranoj tabeli.',
	'hide code' => 'Sakrij ovaj kod',
	'printer friendly view' => 'Pregled prilagođen štampaču',
	'save as csv' => 'Skini kao csv fajl (zarezom-odvojene vrednosti)',
	...
	'Print Preview Detail View' => 'Detaljni Pregled pre Štampe',
	'Print Preview Table View' => 'Tabelarni Pregled pre Štampe',
	'Print' => 'Pregled Pre Štampe',
	...
	'No matches found!' => 'Nije nađenao podudaranje!',
	'Start typing to get suggestions' => 'Započnite sa kucanjem da dobijete predloge.',
	'are you sure?' => 'Da li želite da izbrišete ovaj unos?',
	'add new record' => 'Dodaj novi unos',
	'update record' => 'Izmeni unos',
	...
	'provide connection data' => 'Molimo unesite sledeće podatke da bi napravili vezu ka bazi:',
	...
	'forgot password' => 'Zaboravili ste šifru? <a href=membership_passwordReset.php>Kliknite ovde</a>',
	'browse as guest' => '<a href=index.php>Nastavite razgledanje kao gost</a>',
	'no table access' => 'Nemate dovoljno dozvola da biste pristupili stranici ovde. Molimo prijavite se prvo.',
	'signup' => 'Upišite se',
	...
	'empty user' => "Molimo unesite korisničko ime u polje prvo i kliknite 'Proveri dostupnost'.",
	'thanks' => 'Hvala Vam što ste se upisali!',
	'sign in no approval' => 'Ukoliko ste izabrali grupu koja ne zahteva odobrenje admina, možete se odmah prijaviti <a href=index.php?signIn=1>ovde</a>.',
	...
	'username empty' => 'Morate obezbediti korisničko ime. Vratite se nazad i iskucajte korisničko ime',
	...
	'group invalid' => 'Neispravna grupa. Vratite se nazad i izmenite izbor grupe.',
	...
	'password reset message' => "Dragi članu, \n Ukoliko ste zahtevali da resetujete/izmenite Vašu šifru, molimo kliknite na sledeći link: \n <ResetLink> \n\n Ukoliko niste poslali zahtev za resetom/izmenom šifre, ignorišite ovu poruku. \n\n Pozdrav.",
	'password reset ready' => 'Email sa uputstvima za resetovanje šifre je poslat na Vašu registrovanu email adresu. Molimo ostavite otvorenu ovu stranicu i pratite uputstva iz email poruke.<br><br>Ukoliko ne primite ovu poruku u sledećih 5 minuta, pokušajte sa resetom šifre opet, i proverite da li ste uneli korisničko ime ili email adresu ispravno.',
	...
	'password change' => 'Stranica za Izmenu Šifre',
	'new password' => 'Nova šifra',
	'password reset done' => 'Vaša šifra je uspešno izmenjena. Možete se <a href=index.php?signOut=1>prijaviti sa novom šifrom ovde</a>.',
	'Loading ...' => 'Učitavanje ...',
	...
	'Update profile' => 'Izmeni profil',
	'Update password' => 'Ažuriraj šifru',
	'Change your password' => 'Izmeni šifru',
	...
	'Your profile was updated successfully' => 'Vaš profil je uspešno izmenjen',
	'Your password was changed successfully' => 'Vaša šifra je uspešno izmenjena',
	'Your IP address' => 'Vaša IP adresa',
	'Records to display' => 'Unosa za prikaz',
	'Jump to' => 'Skoči na ...',
	'check username availability' => 'Proveri da li je korisničko ime zauzeto',
