...
$Translation = [
	...
	'no' => 'Ne',
	'group' => 'Skupina',
	'check availability' => 'Zkontrolovat zda lze pou&#382;ít toto u&#382;ivatelské jméno',
	'password' => 'Heslo&nbsp;',
	...
	'comparison operator' => 'Srovnávací operátor',
	'comparison value' => 'Srovnávaná hodnota',
	'and' => 'A',
	'or' => 'Nebo',
	'equal to' => 'Rovno',
	'not equal to' => 'Není rovno',
	'greater than' => 'Vět&scaron;í ne&#382;',
	'greater than or equal to' => 'Vět&scaron;í nebo rovno',
	'less than' => 'Men&scaron;í ne&#382;',
	'less than or equal to' => 'Men&scaron;í nebo rovno',
	'like' => 'Jako',
	'not like' => 'Není jako',
	'is empty' => 'Je prázdné',
	...
	'saved filters instructions' => 'Zkopírujte ní&#382;e uvedený kód a vlo&#382;te jej do HTML souboru pro ulo&#382;ení Vámi právě definovaného filtru. V budoucnu se k němu budete moci kdykoliv vrátit bez nutnosti jeho definování. Tento HTML kód mů&#382;ete ulo&#382;it na svůj počítač nebo na kterýkoliv server zpřístupnit přes něj filtrovaný tabulkový pohled.',
	'hide code' => 'Skrýt tento kód',
	'printer friendly view' => 'Tiskový náhled',
	'save as csv' => 'Stáhnout jako soubor csv (hodnoty oddělené čárkami)',
	'edit filters' => 'Úprava filtrů',
	'clear filters' => 'Smazání filtrů',
	...
	"couldn't delete" => "Nelze smazat záznam, z důvodu výskytu <RelatedRecords> souvisejících záznamů v tabulce '<TableName>'",
	'confirm delete' => "Záznam má <RelatedRecords> související záznamy v tabulce '<TableName>'. Opravdu jej smazat? <Delete> &nbsp; <Cancel>",
	'yes' => 'Ano',
	'pkfield empty' => ' pole je primárním klíčem, proto nemů&#382;e být prázdné.',
	'upload image' => 'Nahrát nový soubor ',
	'select image' => 'Vybrat obrázek ',
	'remove image' => 'Odstranit soubor',
	'month names' => 'Leden,Únor,Březen,Duben,Květen,Červen,Červenec,Srpen,Září,Říjen,Listopad,Prosinec',
	'field not null' => ' musí být vyplněné.',
	'*' => '*',
	'today' => 'Dnes',
	...
	'query:' => 'Dotaz:',
	'< back' => '&lt; Zpět',
	"if you haven't set up" => "Pokud je&scaron;tě nemáte nastavenu databázi, mů&#382;ete to provést kliknutím <a href='setup.php'>zde</a>.",
	'file too large' => 'Chyba: Soubor, který jste nahrál převy&scaron;uje maximální povolenou velikost <MaxSize> KB',
	'invalid file type' => 'Chyba: Tento typ souboru není povolen. Pouze soubory typů <FileTypes> mohou být nahrány',
	'goto start page' => 'Zpět na hlavní stránku',
	'no db connection' => 'Nelze navázat spojení s databází.',
	'no db name' => "Nelze zpřístupnit databázi '<DBName>' na tomto serveru.",
	'provide connection data' => 'Zadejte následující data pro přístup k databázi:',
	'mysql server' => 'MySQL server (host)',
	'mysql username' => 'MySQL u&#382;ivatelské jméno',
	'mysql password' => 'MySQL heslo',
	'mysql db' => 'Název databáze',
	'connect' => 'Připojit',
	'setup performed' => 'Setup already performed on',
	'delete md5' => "Pokudchcete urychlit nastavení při pří&scaron;tím spu&scaron;tění, sma&#382;te soubor 'setup.md5' v tomto adresáři.",
	'table exists' => 'Tabulka <b><TableName></b> existuje, obsahuje <NumRecords> záznamů.',
	'failed' => 'Selhalo',
	'mysql said' => 'MySQL řeklo:',
	'table uptodate' => 'Tabulka je aktuální.',
	'couldnt count' => 'Nelze spočítat záznamy v tabulce <b><TableName></b>',
	'creating table' => 'Vytváření tabulky <b><TableName></b> ... ',
	'tableAccessDenied' => 'Nemáte oprávnění pro přístup.',
	'not signed in' => 'Nejste přihlá&scaron;en',
	'sign in' => 'Přihlásit',
	'signed as' => 'Přihlá&scaron;ený u&#382;ivatel',
	'admin setup needed' => 'Nastavení správce nebylo provedeno. Přihla&scaron;te se, prosím, do <a href=admin/>sekce pro správu</a> pro provedení nastavení.',
	'db setup needed' => 'Nastavení programu je&scaron;tě nebylo provedeno. Nejdříve se přihlaste na <a href=setup.php>stránku nastavení</a>.',
	'login failed' => 'Vá&scaron; poslední pokus o přihlá&scaron;ení selhal. Zkuste to znovu.',
	'sign in here' => 'Přihlá&scaron;ení',
	...
	'no table access' => 'Nemáte dostatečná oprávnění pro přístup do aplikace. Nejprve se prosím přihla&scaron;te.',
	'user already exists' => "U&#382;ivatelské jméno '<MemberID>' ji&#382; existuje. Zkuste jiné u&#382;ivatelské jméno.",
	'user available' => "U&#382;ivatelské jméno '<MemberID>' lze pou&#382;ít.",
	'empty user' => "Nejprve napi&scaron;te do pole své u&#382;ivatelské jméno a poté klikněte na 'Zkontrolovat dostupnost'.",
	'thanks' => 'Děkujeme za registraci!',
	'sign in no approval' => 'Pokud máte vybránu skupinu, která nepodléhá schválení správcem systému, mů&#382;ete se zaregistrovat <a href=index.php?signIn=1>zde</a>.',
	'sign in wait approval' => 'Pokud máte vybránu skupinu, která podléhá schválení správcem systému, počkejte prosím na email, potvrzující schválení přístupu.',
	'username empty' => 'Musíte zadat u&#382;ivatelské jméno. Vra&#357;te se prosím a zadejte své u&#382;ivatelské jméno',
	'password invalid' => 'Musíte zadat heslo, obsahující minimálně 4 znaky, bez mezer. Vraťte se prosím a zadejte platné heslo',
	'password no match' => 'Heslo nesouhlasí. Vraťte se prosím a zadejte správné heslo',
	'username exists' => 'U&#382;ivatelské jméno ji&#382; existuje. Vraťte se prosím a vyberte si jiné u&#382;ivatelské jméno.',
	'email invalid' => 'Chybně zadaná emailová adresa. Vraťte se prosím a zadejte správnou emailovou adresu.',
	'group invalid' => 'Neplatná skupina. Vraťte se prosím a opravte výběr skupiny.',
	'sign up here' => 'Registrace',
	'registered? sign in' => 'Jste ji&#382; registrován? <a href=index.php?signIn=1>Přihlásit</a>.',
	'sign up disabled' => 'Promiňte, ale registrace je dočasně pozastavena správcem systému. Zkuste to později.',
	'groups *' => 'Pokud vyberete registraci označenou hvězdičkou (*), nebudete se moci přihlásit bez souhlasu správce systému, který obdr&#382;íte emailem.',
	'sign up' => 'Registrovat',
	'Jump to' => 'Přejít na ...',
	'check username availability' => 'Zkontrolovat zda lze pou&#382;ít toto u&#382;ivatelské jméno',
