...
$Translation = [
	...
	'no' => '否',
	'group' => ' 组',
	'check availability' => '看看这个用户名是否可用',
	'password' => '密码',
	...
	'select a table' => '跳转到 ...',
	'quick search' => '快速搜索',
	'records x to y of z' => '从 <FirstRecord> 到 <LastRecord> 共 <RecordCount> 记录',
	'filters' => '筛选',
	'filter' => '筛选',
	'filtered field' => '筛选字段',
	...
	'is not empty' => '不是空的',
	'apply filters' => '运用筛选',
	'save filters' => '保存和运用筛选',
	'saved filters title' => '用于筛选的HTML代码',
	'saved filters instructions' => '复制下面的代码并粘贴到一个HTML文本文件以保存您刚才定义的筛选使您可以在今后任何时候再使用而无需重新定义。您可以保存这段代码在您的计算机上或在任何服务器上以便访问此表览。',
	'hide code' => '隐藏此代码',
	'printer friendly view' => '适用打印机的视图',
	'save as csv' => '作为CVS的文档下载（用逗号分隔的值）',
	'edit filters' => '编辑筛选',
	'clear filters' => '清除筛选',
	'order by' => '排序',
	'go to page' => '翻到页数:',
	...
	'With selected records' => '被选中的记录',
	'Print Preview Detail View' => '打印预览详细视图',
	'Print Preview Table View' => '打印预览表格视图',
	'Print' => '打印',
	'Cancel Printing' => '取消打印',
	'Cancel Selection' => '取消选择',
	'Maximum records allowed to enable this feature is' => '能启用此功能的最多记录数是：',
	'No matches found!' => '没有找到匹配',
	'Start typing to get suggestions' => '开始键入以得到建议.',
	'are you sure?' => '您确定要删除此记录?',
	'add new record' => '添加新记录',
	'update record' => '更新记录',
	'deselect record' => '取消选择的记录 ',
	"couldn't delete" => '不能删除记录，因为在表 [<TableName>] 中存在相关记录<RelatedRecords> ,',
	'confirm delete' => '该记录在表[<TableName>]中有相关记录 <RelatedRecords> . 您是否仍要删除它? <Delete> &nbsp; <Cancel>',
	'yes' => '是',
	'pkfield empty' => ' 字段是主键字段不能是空的.',
	'upload image' => '上传新文件 ',
	'select image' => '选择一个图像 ',
	'remove image' => '删除文件',
	'month names' => '一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月',
	'field not null' => '您不能留该字段空白.',
	'*' => '*',
	'today' => '今天',
	'Hold CTRL key to select multiple items from the above list.' => '按住CTRL键从上面的列表中选择多个条目，.',
	'Save New' => '保存为新建',
	'Save As Copy' => '保存为复制',
	'Deselect' => '取消',
	'Add New' => '添加新建',
	...
	'query:' => '查询:',
	'< back' => '&lt; 返回',
	"if you haven't set up" => "如果您还没有建立数据库，您可以通过点击 <a href='setup.php'>这里</a>.",
	'file too large' => '错误：您上传的文件超过了允许的最大尺寸 <MaxSize> KB',
	'invalid file type' => '错误：此类型的文件是不允许的. 只有<FileTypes>的文件可以上传',
	'goto start page' => '回到起始页',
	'no db connection' => '不能建立一个数据库连接.',
	'no db name' => "在本服务器上无法访问指定的数据库 '<DBName>' .",
	'provide connection data' => '请提供下列数据以连接数据库:',
	'mysql server' => 'MySQL 服务器 (host)',
	'mysql username' => 'MySQL 用户名',
	'mysql password' => 'MySQL 密码',
	'mysql db' => '数据库名字',
	'connect' => '连接',
	'setup performed' => '安装程序已完成',
	'delete md5' => "如果您想强制再运行安装程序，您必须从这个文件夹内先删除文件 'setup.md5'.",
	'table exists' => '表 <b><TableName></b> 已存在, 内有 <NumRecords> 记录.',
	'failed' => '失败',
	'mysql said' => 'MySQL 说:',
	'table uptodate' => '表是最新的.',
	'couldnt count' => '无法计数表<b><TableName></b>的记录',
	'creating table' => '正在创建表 <b><TableName></b> ... ',
	'tableAccessDenied' => '对不起！您没有权限访问此表。请与管理员联系.',
	'not signed in' => '您没有登录',
	'sign in' => '登录',
	'signed as' => '登录为',
	'admin setup needed' => '尚未安装管理员。请登录到 <a href=admin/>管理员控制面板</a> 执行安装程序.',
	'db setup needed' => '尚未安装程序. 请先登录到 <a href=setup.php>安装页面</a> .',
	'new record saved' => '新的记录已成功保存.',
	'record updated' => '更改已成功保存.',
	'login failed' => '您以前的登录尝试失败。再试试.',
	'sign in here' => '在此登录',
	'remember me' => '记住我',
	'go to signup' => '没有用户名? <br>&nbsp; <a href=membership_signup.php>在此注册</a>',
	'forgot password' => '忘了您的密码? <a href=membership_passwordReset.php>点击这里</a>',
	'browse as guest' => '<a href=index.php>作为来访者继续浏览</a>',
	'no table access' => '您没有足够的权限访问这里的任何网页。请先登录.',
	'signup' => '注册',
	'user already exists' => "用户名 '<MemberID>' 已经存在。尝试另一个用户名.",
	'user available' => "用户名 '<MemberID>' 可用的，您可以用它.",
	'empty user' => "请先键入用户名框，然后点击 '检查是否可用'.",
	'thanks' => '谢谢您注册!',
	'sign in no approval' => '如果您选择了一个不需要管理员批准的组, 您现在就可以在<a href=index.php?signIn=1>这里</a>登录.',
	'sign in wait approval' => '如果您选择了一个需要管理员批准的组，，请等待一个电子邮件确认您的批准.',
	'username empty' => '必须提供用户名。请返回并键入用户名',
	'password invalid' => '您必须提供至少4个字符，不含空格的密码。请返回并键入有效的密码。',
	'password no match' => '密码不匹配。请返回并改正密码',
	'username exists' => '用户名已经存在。请返回选择一个不同的用户名.',
	'email invalid' => '无效的电子邮件地址。请返回并改正您的电子邮件地址.',
	'group invalid' => '无效的组。请返回并改正组的选择.',
	'sign up here' => '在这里注册!',
	'registered? sign in' => '已注册过? <a href=index.php?signIn=1>在这里登录</a>.',
	'sign up disabled' => '对不起！管理员暂时禁用注册。稍后再试.',
	'groups *' => '如果您选择注册一个标有星号（*）的组，您将无法登录直到管理员批准您。您被批准后会收到一封电子邮件时.',
	'sign up' => '注册',
	'password reset' => '密码重置页面',
	'password reset details' => '在下面输入您的用户名或电子邮件地址。然后我们将发送一个特殊链接到您的电子邮件。当您点击链接，您会被要求输入新的密码.',
	'password reset subject' => '密码重置说明',
	'password reset message' => "亲爱的会员, \n 如果您曾经要求重设/更改您的密码，请点击此链接: \n <ResetLink> \n\n 如果您没有要求密码重设/更改，请忽略此信息. \n\n 谨此问候.",
	'password reset ready' => '一封有密码重置指令的邮件已发送到您注册的电子邮件地址。请保持这个浏览器窗口并按照电子邮件的指示.<br><br>如果您在5分钟内没有收到这封邮件，尝试再重置密码，并确保您输入正确的用户名或电子邮件地址.',
	'password reset invalid' => '无效的用户名或密码. <a href=membership_passwordReset.php>再试一次</a>, 或者<a href=index.php>回到主页</a>.',
	'password change' => '密码更改页面',
	'new password' => '新密码',
	'password reset done' => '您的密码已经更改成功。您可以 <a href=index.php?signOut=1>在这里用新密码登录</a>.',
	'Loading ...' => '加载中 ...',
	'No records found' => '没有找到记录',
	'You can add children records after saving the main record first' => '您在保存主记录后可以添加子记录',
	'ascending' => '升序',
	'descending' => '降序',
	'then by' => '然后按照',
	'Legend' => '图例',
	...
	'Edit' => '编辑',
	'View' => '察看',
	'Only your own records' => '只有您自己的记录',
	'All records owned by your group' => '您的组所有拥有的全部记录',
	'All records' => '全部记录',
	'Not allowed' => '不允许',
	'Your info' => '您的信息',
	'Hello user' => '您好 %s!',
	...
	'Old password' => '旧密码',
	'Password strength: weak' => '密码保密度：弱',
	'Password strength: good' => '密码保密度：好',
	'Password strength: strong' => '密码保密度：强',
	'Wrong password' => '错误密码',
	'Your profile was updated successfully' => '您个人资料更新成功',
	'Your password was changed successfully' => '您的密码已经更改成功',
	'Your IP address' => '您的IP地址',
	'Jump to' => '跳转到 ...',
	'check username availability' => '看看这个用户名是否可用',
