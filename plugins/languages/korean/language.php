...
$Translation = [
	...
	'no' => '하지',
	'group' => '그룹',
	'check availability' => '이 이름 을 사용할 수 있는지 확인',
	'password' => '암호',
	...
	'select a table' => '로 이동 ...',
	'quick search' => '빠른 검색',
	'records x to y of z' => '기록 <FirstRecord> 에 <LastRecord> 의 <RecordCount>',
	'filters' => '필터',
	'filter' => '필터',
	'filtered field' => '필터링 된 필드',
	...
	'less than' => '미만',
	'less than or equal to' => '보다 작 거나 같음',
	'like' => '같은',
	'not like' => '좋아하지',
	'is empty' => '비어',
	'is not empty' => '비어 있지',
	'apply filters' => '필터를 적용',
	'save filters' => '저장 및 필터를 적용',
	'saved filters title' => '적용된 필터에 대한 HTML 코드',
	'saved filters instructions' => '아래의 코드를 복사 하고 다시 정의 하지 않고 미래에 언제든지 돌아갈 수 있도록 정의한 필터를 저장 하는 HTML 파일에 붙여 넣습니다. 당신은 당신의 컴퓨터 또는 서버에서이 HTML 코드를 저장하고 그것을 통해 이 미리 여과 테이블 뷰 에 액세스 할 수 있습니다.',
	'hide code' => '이 코드를 숨기기',
	'printer friendly view' => '인쇄용 보기',
	'save as csv' => 'CSV 파일로 다운로드 ( 쉼표로 구분 된 값 )',
	'edit filters' => '편집 필터',
	'clear filters' => '필터 지우기',
	'order by' => '순서',
	'go to page' => '페이지로 이동:',
	'none' => '없음',
	'Select all records' => '모든 레코드를 선택',
	'With selected records' => '선택한 레코드 와',
	'Print Preview Detail View' => '인쇄 미리 보기 상세보기',
	'Print Preview Table View' => '미리보기 테이블보기 인쇄하기',
	'Print' => '인쇄',
	'Cancel Printing' => '인쇄 취소',
	'Cancel Selection' => '선택 취소',
	'Maximum records allowed to enable this feature is' => '최대 기록은 이 기능 이 가능하도록 허용',
	'No matches found!' => '일치하는 찾을 수 없습니다!',
	'Start typing to get suggestions' => '제안을 얻을 입력을 시작합니다.',
	'are you sure?' => '이 기록을 삭제 하시겠습니까 ?',
	'add new record' => '새 레코드를 추가',
	'update record' => '업데이트 기록',
	'deselect record' => '기록 의 선택을 취소합니다',
	"couldn't delete" => '때문에 의 존재로 기록을 삭제할 수 없습니다 <RelatedRecords> 테이블의 관련 기록 (들) [<TableName>]',
	'confirm delete' => '이 레코드 에는 <RelatedRecords> 테이블의 관련 기록 (들) [<TableName>]. 당신은 여전히 ​​삭제 하시겠습니까? <Delete> &nbsp; <Cancel>',
	'yes' => '예',
	'pkfield empty' => ' 필드는 기본 키 필드 와 비어있을 수 없습니다 .',
	'upload image' => '새 파일을 업로드 ',
	'select image' => '이미지를 선택 ',
	'remove image' => '파일을 제거합니다',
	'month names' => '1 월, 2 월, 3 월, 4 월, 5 월 , 6 월, 7 월, 8 월 , 9 월, 10 월, 11 월 12 월',
	'field not null' => '당신은 이 필드를 비워 둘 수 없습니다.',
	'*' => '*',
	'today' => '오늘',
	'Hold CTRL key to select multiple items from the above list.' => '위의 목록에서 여러 항목을 선택 하려면 Ctrl 키를 누른 상태 .',
	'Save New' => '저장 새로운',
	'Save As Copy' => '저장 복사',
	'Deselect' => '취소',
	'Add New' => '새로 추가',
	...
	'query:' => '질문:',
	'< back' => '백',
	"if you haven't set up" => "아직 데이터베이스를 설정하지 않은 경우 , 당신은 클릭하세요 <a href='setup.php'>here</a>.",
	'file too large' => '오류 : 업로드파일 의 최대 허용 크기를 초과 <MaxSize> KB',
	'invalid file type' => '오류 : 이 파일에 허용되지 않습니다. 만 <FileTypes> 파일을 업로드 할 수 있습니다',
	'goto start page' => '돌아 가기 페이지 를 시작합니다',
	'no db connection' => '데이터베이스 연결을 설정할 수 없습니다 .',
	'no db name' => "명명 된데이터베이스에 액세스 할 수 없습니다 '<DBName>' 이 서버 에 .",
	'provide connection data' => '데이터베이스에 연결 하기 위해 다음과 같은 데이터를 제공 하십시오:',
	'mysql server' => 'MySQL 서버 (host)',
	'mysql username' => 'MySQL의 사용자 이름',
	'mysql password' => 'MySQL의 비밀',
	'mysql db' => '데이터베이스 이름',
	'connect' => '연결',
	'setup performed' => '설치 프로그램이 이미 수행',
	'delete md5' => "다시 실행 설정 을 강제 하려면 먼저 이 폴더 에서 파일 ' setup.md5 '을 삭제해야합니다.",
	'table exists' => '테이블 <b><TableName></b> 포함 , 존재 <NumRecords> 기록.',
	'failed' => '실패한',
	'mysql said' => 'MySQL은 말했다 :',
	'table uptodate' => '표 는 최신 입니다 .',
	'couldnt count' => '테이블 의 레코드를 카운트 할 수 없습니다 <b><TableName></b>',
	'creating table' => '작성 테이블 <b><TableName></b> ... ',
	'tableAccessDenied' => '죄송합니다 ! 이 테이블에 액세스 할 수있는 권한이 없습니다. 관리자 에게 문의하시기 바랍니다.',
	'not signed in' => '당신은 로그인 되지 않습니다',
	'sign in' => '로그인',
	'signed as' => '로 서명',
	'admin setup needed' => '관리자 설정이 수행되지 않았습니다. 에 로그인 하십시오 <a href=admin/>관리자 제어판</a> 설정을 수행 할 수 있습니다.',
	'db setup needed' => '프로그램 설치가 아직 수행되지 않았습니다. 에 로그인 하십시오 <a href=setup.php>설정 페이지</a> 처음으로.',
	'new record saved' => '새 레코드 가 성공적으로 저장되었습니다.',
	'record updated' => '변경 사항이 저장되었습니다.',
	'login failed' => '이전 로그인 시도가 실패했습니다. 다시 시도하십시오.',
	'sign in here' => '여기에 로그인',
	'remember me' => '저를 기억',
	'go to signup' => '사용자 이름 이 없으십니까? <br>&nbsp; <a href=membership_signup.php>여기서 가입</a>',
	'forgot password' => '비밀번호를 잊어 버렸습니까? <a href=membership_passwordReset.php>여기를 클릭하십시오</a>',
	'browse as guest' => '<a href=index.php>게스트로 탐색 계속</a>',
	'no table access' => '여기에서 모든 페이지 에 액세스 할 수있는 충분한 권한이 없습니다. 로그인 해주세요 .',
	'signup' => '가입',
	'user already exists' => "사용자 이름 '<MemberID>' 이미 존재합니다. 다른 이름 을 사용해보십시오.",
	'user available' => "사용자 이름 '<MemberID>' 사용할 수 있고 당신은 그것을 걸릴 수 있습니다.",
	'empty user' => "먼저 ' 가능 여부 확인 '을 클릭 상자에 사용자 이름을 입력하세요.",
	'thanks' => '가입 주셔서 감사합니다!',
	'sign in no approval' => '당신이 관리자 의 승인을 필요로하지 않는 그룹을 선택한 경우 , 당신은 지금 에 로그인 할 수 있습니다 <a href=index.php?signIn=1>여기에</a>.',
	'sign in wait approval' => '당신이 관리자 의 승인을 필요로하는 그룹을 선택한 경우 , 승인 확인메일 을 기다려주십시오.',
	'username empty' => '당신은 사용자 이름을 제공해야합니다. 돌아가서 사용자 이름을 입력 하십시오',
	'password invalid' => '공백 없이 4 자 이상의 암호를 제공해야합니다. 돌아가서 올바른 암호를 입력 하십시오',
	'password no match' => '비밀번호 가 일치하지 않습니다. 돌아가서 암호를 수정하십시오',
	'username exists' => '사용자 이름 이 이미 존재합니다. 돌아가서 다른 이름을 선택하십시오.',
	'email invalid' => '이메일 주소가 잘못되었습니다 . 돌아가서 이메일 주소를 수정하십시오.',
	'group invalid' => '잘못된 그룹 . 돌아가서그룹 선택 을 수정하십시오.',
	'sign up here' => '여기에 가입하세요!',
	'registered? sign in' => '이미 등록 ? <a href=index.php?signIn=1>여기서 로그인</a>.',
	'sign up disabled' => '죄송합니다 ! 가입 일시적으로 관리자에 의해 비활성화됩니다. 나중에 다시 시도하십시오.',
	'groups *' => '당신이 그룹에 가입 하도록 선택하는 경우 별표로 표시 (*), 당신은 관리자가 당신 을 승인 할 때까지 로그인 할 수 없습니다. 당신이 승인 하면이메일을 받게됩니다 .',
	'sign up' => '회원 가입',
	'password reset' => '암호 재설정 페이지',
	'password reset details' => '사용자 이름 또는 아래에 이메일 주소를 입력합니다. 우리는 다음 이메일에 특별한 링크를 보내드립니다. 해당 링크를 클릭 한 후 새 암호를 입력 하라는 메시지가 표시됩니다 .',
	'password reset subject' => '암호 재설정 안내',
	'password reset message' => "친애하는 회원 , \n 당신 은 / 다시 암호를 변경 하도록 요청 한 경우 , 이 링크를 클릭하십시오 : \n <ResetLink> \n\n 암호 재설정 / 변경을 요청 하지 않은 경우 , 이 메시지를 무시 하십시오 . \n\n 감사합니다.",
	'password reset ready' => '암호 재설정 지침에 이메일이 등록 된 이메일 주소로 발송되었습니다. 해당 이메일 메시지의 지침을 따르십시오.<br><br>당신이 5 분 이내에 이메일을 받지 못할 경우 , 다시 비밀번호를 재설정 해보십시오 , 당신이올바른 사용자 이름 또는 이메일 주소를 입력 해야합니다.',
	'password reset invalid' => '사용자 이름 또는 비밀번호가 잘못되었습니다 . <a href=membership_passwordReset.php>다시 시도</a>, 또는 이동 <a href=index.php>다시 홈페이지로</a>.',
	'password change' => '비밀번호 변경 페이지',
	'new password' => '새로운 비밀번호',
	'password reset done' => '비밀번호 가 성공적으로 변경되었습니다. 당신은 할 수 있습니다 <a href=index.php?signOut=1>여기에 새로운 비밀번호를 사용하여 로그인</a>.',
	'Loading ...' => '로드 중 ...',
	'No records found' => '기록은 찾을 수',
	'You can add children records after saving the main record first' => '먼저 주요 기록을 저장 한 후 자식 레코드 를 추가 할 수 있습니다',
	'ascending' => '오름차순',
	'descending' => '내림차순',
	'then by' => '다음 으로',
	'Legend' => '전설',
	...
	'Edit' => '편집',
	'View' => '전망',
	'Only your own records' => '만 자신의 기록',
	'All records owned by your group' => '당신의 그룹이 소유 모든 기록',
	'All records' => '모든 기록',
	'Not allowed' => '허용되지 않음',
	'Your info' => '당신의 정보',
	'Hello user' => '안녕하세요 %s!',
	'Your access permissions' => '귀하의 액세스 권한',
	'Update profile' => '프로파일 업데이트',
	'Update password' => '업데이트 암호',
	'Change your password' => '암호 변경',
	'Old password' => '이전 암호',
	'Password strength: weak' => '암호 강도 : 약',
	'Password strength: good' => '암호 강도 : 좋은',
	'Password strength: strong' => '암호 강도 : 강한',
	'Wrong password' => '잘못된 암호',
	'Your profile was updated successfully' => '프로필 이 성공적으로 업데이트되었습니다',
	'Your password was changed successfully' => '비밀번호 가 성공적으로 변경되었습니다',
	'Your IP address' => '당신의 IP 주소',
	'Records to display' => '기록 표시',
	'Setup Data' => '데이터 설정',
	'Database Information' => '데이터베이스 정보',
	'Admin Information' => '관리 정보',
	'setup intro 1' => '구성 파일 이 없습니다 . 응용 프로그램이 작동을 위해서는이 설정이 필요합니다 .<br><br>이 설정 페이지에서는 해당 파일을 만드는 데 도움이됩니다 . 그러나 일부 서버 구성 이 작동하지 않을 수 있습니다 . 이 경우 에는 폴더 사용 권한을 조정하거나, 수동으로 설정 파일 을 작성 해야 할 수도 있습니다.',
	'setup intro 2' => '새 AppGini 응용 프로그램 에 오신 것을 환영합니다! 시작하기 전에 , 우리는 데이터베이스 에 대한 정보 가 필요합니다. 당신은 진행하기 전에 다음 사항을 알아야합니다 :<ol><li>데이터베이스 서버 (host)</li><li>데이터베이스 이름</li><li>데이터베이스 사용자 이름</li><li>데이터베이스 암호</li></ol>위의 항목은 아마 당신의 웹 호스팅 제공 업체 에 의해 당신에게 제공 했다 . 이 정보가없는 경우에, 당신은 그들에게 연락 하거나 여기 계속하기 전에 자신의 서비스 설명서를 참조 해야합니다. 준비가 되면 , 우리가 시작 하자!',
	'setup finished' => '<b>성공!</b><br><br>귀하의 AppGini 응용 프로그램이 설치되어 있습니다. 여기 를 사용하려면 몇 가지 제안 은 다음과 같습니다 :',
	'setup next 1' => '있는 경우 , 데이터를 추가하거나 기존 데이터 와 작동하도록 응용 프로그램을 사용하여 시작합니다.',
	'setup next 2' => '가져 오기CSV 파일 에서 응용 프로그램 에 데이터를 기존의 .',
	'setup next 3' => '당신이 많은 다른 응용 프로그램 의 설정을 변경할 수 있습니다 관리자 홈페이지 로 이동합니다.',
	'db_name help' => '당신이 당신의 AppGini 응용 프로그램을 실행 하려는 데이터베이스 의 이름입니다.',
	'db_server help' => '<i>localhost</i> 대부분의 서버 에서 작동합니다. 그렇지 않으면 , 당신은 당신의 웹 호스팅 제공 업체 에서이 정보를 얻을 수 있어야합니다 .',
	'db_username help' => 'MySQL의 사용자 이름',
	'db_password help' => 'MySQL의 암호',
	'username help' => '당신은 이 관리 지역 에 액세스하는 데 사용할 싶습니다 \ 관리자 사용자 이름을 지정합니다. 네 자 이상 이어야합니다 .',
	'password help' => '관리 지역 에 액세스 할 수있는 강력한 암호를 지정합니다.',
	'email help' => '당신이 관리자 알림을 보내려는 이메일 주소를 입력합니다.',
	'Continue' => '계속 ...',
	'Lets go' => '가자!',
	'Submit' => '제출',
	'Hide' => '숨기기 도움',
	'Database info is correct' => '&#10003; 데이터베이스 정보 가 정확한지 !',
	'Database connection error' => '&#10007; 데이터베이스 연결 오류 !',
	'The following errors occured' => '다음과 같은 오류 가 발생했습니다',
	'failed to create config instructions' => '이것은 대부분의 아마 당신의 웹 서버에서 파일을 생성 방지하기 위해 설정된 폴더 권한 때문이다. 걱정하지 마세요 ! 당신은 여전히 ​​수동으로 설정 파일 을 만들 수 있습니다.<br><br>그냥 텍스트 편집기 에 다음 코드를 붙여 넣기 하고 파일을 저장 "config.php", 다음 FTP 또는 서버 의 폴더 % s의 다른 방법을 사용하여 업로드합니다.',
	'Only show records having filterer' => '만 표시 레코드 곳 %s 이다 %s',
	"You don't have enough permissions to delete this record" => '이 레코드를 삭제 하기에 충분한 권한이 없습니다',
	"Couldn't delete this record" => '이 기록을 삭제할 수 없습니다',
	'The record has been deleted successfully' => '기록 이 삭제 되었습니다',
	"Couldn't save changes to the record" => '레코드 에 대한 변경 사항을 저장할 수 없습니다',
	"Couldn't save the new record" => '새로운 기록 을 저장할 수 없습니다',
	'More' => '더',
	'Confirm deleting multiple records' => '여러 레코드를 삭제 확인',
	'<n> records will be deleted. Are you sure you want to do this?' => '<n> 기록 이 삭제됩니다. 이 작업을 수행 하시겠습니까 ?',
	'Yes, delete them!' => '예, 삭제 !',
	'No, keep them.' => '아니, 보관하십시오.',
	'Deleting record <i> of <n>' => '삭제 기록 <i> 의 <n>',
	'Delete progress' => '진행 삭제',
	'Show/hide details' => '세부 정보보기 / 숨기기',
	'Connection error' => '연결 오류',
	'Add more actions' => '추가 조치 추가',
	'Update progress' => '업데이트 진행',
	'Change owner' => '소유자 변경',
	'Updating record <i> of <n>' => '업데이트 기록 <i> 의 <n>',
	'Change owner of <n> selected records to' => '의 소유자 변경 <n> 에 선택한 레코드',
	'Jump to' => '로 이동 ...',
	'check username availability' => '이 이름 을 사용할 수 있는지 확인',
