<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('credits', "create table if not exists `credits` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `ligne_budgetaire` INT unsigned null , `ligne_credit` INT unsigned not null , `date` DATE not null , `intitule` VARCHAR(100) null , `montant` DECIMAL(10,2) not null , `notes` TEXT null ) CHARSET utf8", $silent, array( "ALTER TABLE `credits` ADD `reste_depenser` DECIMAL(10,2) null ","ALTER TABLE `credits` DROP `reste_depenser`"));
		setupIndexes('credits', array('convention','ligne_budgetaire','ligne_credit'));
		setupTable('ventilation', "create table if not exists `ventilation` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `intitule` VARCHAR(100) not null , `notes` TEXT null , `accorde` DOUBLE(10,2) unsigned null , `reserve` DECIMAL(10,2) null , `liquide` DECIMAL(10,2) null , `utilise` DECIMAL(10,2) null , `reste_engager` DECIMAL(10,2) null , `reservation_salaire` DECIMAL(10,2) null , `reste_depenser` DECIMAL(10,2) null , `prop_ua` DECIMAL(10,1) null ) CHARSET utf8", $silent, array( "ALTER TABLE `ventilation` ADD `reservation_salaire` DECIMAL(10,2) null ","ALTER TABLE `ventilation` ADD `reste_depenser` DECIMAL(10,2) null "));
		setupIndexes('ventilation', array('convention'));
		setupTable('recrutements', "create table if not exists `recrutements` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `intitule` VARCHAR(100) not null , `beneficiaire` INT unsigned null , `date_debut` DATE null , `date_fin` DATE null , `duree` MEDIUMINT unsigned null , `ventilation` INT unsigned null , `notes` TEXT null , `previsionnel` DOUBLE(10,2) unsigned null , `depense` DECIMAL(10,2) null , `reservation_salaire` DECIMAL(10,2) null , `prop_dp` DECIMAL(10,2) null ) CHARSET utf8", $silent);
		setupIndexes('recrutements', array('convention','beneficiaire','ventilation'));
