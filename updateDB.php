<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('lignes_credits', "create table if not exists `lignes_credits` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `ligne_budgetaire` INT unsigned not null , `intitule` VARCHAR(40) not null , `exercice` VARCHAR(10) null , `notes` TEXT null , `ouvert` DECIMAL(10,2) null , `non_liquide` DECIMAL(10,2) null , `liquide` DECIMAL(10,2) null , `utilise` DECIMAL(10,2) null , `disponible` FLOAT(10,2) null , `prop_uo` DECIMAL(10,1) null ) CHARSET utf8", $silent);
