<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('lignes_credits', "create table if not exists `lignes_credits` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `ligne_budgetaire` INT unsigned not null , `intitule` VARCHAR(40) not null , `exercice` VARCHAR(10) null , `notes` TEXT null , `ouvert` DECIMAL(10,2) null , `reserve` DECIMAL(10,2) null , `liquide` DECIMAL(10,2) null , `utilise` DECIMAL(10,2) null , `disponible` FLOAT(10,2) null , `prop_uo` DECIMAL(10,1) null ) CHARSET utf8", $silent);
		...
		setupTable('rubriques', "create table if not exists `rubriques` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `intitule` VARCHAR(100) not null , `notes` TEXT null , `accorde` DOUBLE(10,2) unsigned null , `reserve` DECIMAL(10,2) null , `liquide` DECIMAL(10,2) null , `utilise` DECIMAL(10,2) null , `reste_engager` DECIMAL(10,2) null , `reservation_salaire` DECIMAL(10,2) null , `reste_depenser` DECIMAL(10,2) null , `prop_ua` DECIMAL(10,1) null ) CHARSET utf8", $silent);
		...
		setupTable('depenses', "create table if not exists `depenses` (   `id` INT unsigned not null auto_increment , primary key (`id`), `convention` INT unsigned not null , `ligne_budgetaire` INT unsigned null , `ligne_credit` INT unsigned not null , `date` DATE not null , `intitule` VARCHAR(100) not null , `reference` VARCHAR(40) null , `contrat` INT unsigned null , `beneficiaire` INT unsigned null , `montant` DECIMAL(10,2) not null , `statut` VARCHAR(40) not null default '1' , `ventilation` INT unsigned null , `notes` TEXT null ) CHARSET utf8", $silent, array( "ALTER TABLE depenses ADD `field13` VARCHAR(40)","ALTER TABLE `depenses` CHANGE `field13` `reference` VARCHAR(40) null "));
