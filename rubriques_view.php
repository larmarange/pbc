...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="rubriques-convention sum"></td>';
			$sumRow .= '<td class="rubriques-intitule sum"></td>';
			$sumRow .= '<td class="rubriques-notes sum"></td>';
			$sumRow .= "<td class=\"rubriques-accorde text-right sum\">{$row[0]}</td>";
			$sumRow .= "<td class=\"rubriques-non_liquide text-right sum\">{$row[1]}</td>";
			$sumRow .= "<td class=\"rubriques-liquide text-right sum\">{$row[2]}</td>";
			$sumRow .= "<td class=\"rubriques-utilise text-right sum\">{$row[3]}</td>";
			$sumRow .= "<td class=\"rubriques-reste_engager text-right sum\">{$row[4]}</td>";
			$sumRow .= "<td class=\"rubriques-reservation_salaire text-right sum\">{$row[5]}</td>";
			$sumRow .= "<td class=\"rubriques-reste_depenser text-right sum\">{$row[6]}</td>";
			$sumRow .= '<td class="rubriques-prop_ua sum"></td>';
			$sumRow .= '</tr>';
