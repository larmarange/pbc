...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"CONCAT('<span style=''color: ', IF(`rubriques`.`accorde` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`accorde`, 2, 'ru_RU'), '</span>')" => "accorde",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`reserve` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reserve`, 2, 'ru_RU'), '</span>')" => "reserve",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`liquide` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`liquide`, 2, 'ru_RU'), '</span>')" => "liquide",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`utilise` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`utilise`, 2, 'ru_RU'), '</span>')" => "utilise",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`reste_engager` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_engager`, 2, 'ru_RU'), '</span>')" => "reste_engager",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`reservation_salaire` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reservation_salaire`, 2, 'ru_RU'), '</span>')" => "reservation_salaire",
		"CONCAT('<span style=''color: ', IF(`rubriques`.`reste_depenser` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_depenser`, 2, 'ru_RU'), '</span>')" => "reste_depenser",
	...
	if(strpos($x->HTML, '<!-- tv data below -->')){
		...
		$sumQuery = "select CONCAT('<span style=''color: ', IF(sum(`rubriques`.`accorde`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`accorde`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`reserve`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`reserve`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`liquide`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`liquide`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`utilise`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`utilise`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`reste_engager`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`reste_engager`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`reservation_salaire`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`reservation_salaire`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`rubriques`.`reste_depenser`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`rubriques`.`reste_depenser`), 2, 'ru_RU'), '</span>') from {$x->QueryFrom} {$QueryWhere}";
		$res = sql($sumQuery, $eo);
