	...
	$lookups = array(
		...
		'budgets' => array(
			'convention' => array(
				...
				'parent_from' => '`conventions` LEFT JOIN `personnes` as personnes1 ON `personnes1`.`id`=`conventions`.`porteur` LEFT JOIN `personnes` as personnes2 ON `personnes2`.`id`=`conventions`.`chef_projet` ',
				'filterers' => array(),
				'custom_query' => '',
