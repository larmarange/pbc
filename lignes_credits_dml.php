...
function lignes_credits_insert(){
	...
	if($data['intitule']== ''){
		echo StyleSheet() . "\n\n<div class=\"alert alert-danger\">" . $Translation['error:'] . " 'Intitul&#233; / CFI': " . $Translation['field not null'] . '<br><br>';
		echo '<a href="" onclick="history.go(-1); return false;">'.$Translation['< back'].'</a></div>';
		exit;
	}
	...
	sql('insert into `lignes_credits` set       `convention`=' . (($data['convention'] !== '' && $data['convention'] !== NULL) ? "'{$data['convention']}'" : 'NULL') . ', `ligne_budgetaire`=' . (($data['ligne_budgetaire'] !== '' && $data['ligne_budgetaire'] !== NULL) ? "'{$data['ligne_budgetaire']}'" : 'NULL') . ', `intitule`=' . (($data['intitule'] !== '' && $data['intitule'] !== NULL) ? "'{$data['intitule']}'" : 'NULL') . ', `exercice`=' . (($data['exercice'] !== '' && $data['exercice'] !== NULL) ? "'{$data['exercice']}'" : 'NULL') . ', `notes`=' . (($data['notes'] !== '' && $data['notes'] !== NULL) ? "'{$data['notes']}'" : 'NULL') . ', `ouvert`=' . (($data['ouvert'] !== '' && $data['ouvert'] !== NULL) ? "'{$data['ouvert']}'" : 'NULL') . ', `reserve`=' . (($data['reserve'] !== '' && $data['reserve'] !== NULL) ? "'{$data['reserve']}'" : 'NULL') . ', `liquide`=' . (($data['liquide'] !== '' && $data['liquide'] !== NULL) ? "'{$data['liquide']}'" : 'NULL') . ', `utilise`=' . (($data['utilise'] !== '' && $data['utilise'] !== NULL) ? "'{$data['utilise']}'" : 'NULL') . ', `disponible`=' . (($data['disponible'] !== '' && $data['disponible'] !== NULL) ? "'{$data['disponible']}'" : 'NULL') . ', `prop_uo`=' . (($data['prop_uo'] !== '' && $data['prop_uo'] !== NULL) ? "'{$data['prop_uo']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function lignes_credits_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if($selected_id){
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(exercice)%%>', safe_html($urow['exercice']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(exercice)%%>', html_attr($row['exercice']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(exercice)%%>', urlencode($urow['exercice']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(exercice)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(exercice)%%>', urlencode(''), $templateCode);
