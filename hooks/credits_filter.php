...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="credits_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/051-revenue.png"> 					Crédits (ouverture) Filters</a>
			</h1></div>
		...
		$j(function(){
			...
			$j("#filter_3").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"credits", f:"ligne_budgetaire" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"credits", f:"ligne_credit" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
