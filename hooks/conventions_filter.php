...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="conventions_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/035-legal-document.png"> 					Conventions Filters</a>
			</h1></div>

		
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Statut</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Statut</label></div>
		
		
		<input type="hidden" class="optionsData" name="FilterField[1]" value="3">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[1]" class="filter_3" value='en projet'>en projet				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[1]" class="filter_3" value='soumise pour financement'>soumise pour financement				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[1]" class="filter_3" value='active'>active				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[1]" class="filter_3" value='clôturée'>clôturée				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[1]" class="filter_3" value='refusée'>refusée				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_3 = '<?php echo htmlspecialchars($FilterValue[ 1 ]); ?>';
		$j(function () {
			if (filterValue_3) {
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Bailleur(s)</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Bailleur(s)</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Porteur</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Porteur</label></div>
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_5" name="FilterOperator[3]" value="equal-to">
			<input type="hidden" id="filterfield_5" name="FilterValue[3]" value="<?php echo htmlspecialchars($FilterValue[3]); ?>" size="3">
		</div>
			...
			if ($j("#filterfield_5").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "conventions",                //table name
						f: "porteur"               //field name
					}
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Début</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Début</label></div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text"  class="form-control" id="from-date_8"  name="FilterValue[4]" value="<?php echo htmlspecialchars($FilterValue[4]); ?>" size="10">
		</div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text" class="form-control" id="to-date_8" name="FilterValue[5]" value="<?php echo htmlspecialchars($FilterValue[5]); ?>" size="10">
		</div>
	...
	<script>
		$j(function(){
			...
			$j("#from-date_8" ).on('dp.change' , function(e){
				...
				$j("#to-date_8 ").val(date.format('DD/MM/YYYY')).data("DateTimePicker").minDate(e.date);
			});
		});
	</script>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Fin</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Fin</label></div>
	...
	<script>
		$j(function(){
			...
			$j("#from-date_9" ).on('dp.change' , function(e){
				date = moment(e.date).add(1, 'month');  
				$j("#to-date_9 ").val(date.format('DD/MM/YYYY')).data("DateTimePicker").minDate(e.date);
			});
		});
	</script>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Durée (mois)</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Durée (mois)</label></div>
		...
		<input type="hidden" name="FilterField[9]" value="10">  
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Demandé</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Demandé</label></div>
		
					
		<div class="col-xs-3 col-md-1 vspacer-lg text-center">Between</div>
		<input type="hidden" name="FilterAnd[11]" value="and">
		<input type="hidden" name="FilterField[11]" value="7">   
