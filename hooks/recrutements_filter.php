...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="recrutements_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/067-human-resources-1.png"> 					Recrutements Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Intitulé du poste</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Intitulé du poste</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text"  class="form-control" id="from-date_6"  name="FilterValue[6]" value="<?php echo htmlspecialchars($FilterValue[6]); ?>" size="10">
		</div>

				<div class="col-xs-3 col-md-1 text-center vspacer-lg"> and </div>
		
		<input type="hidden" name="FilterAnd[7]" value="and">
		<input type="hidden" name="FilterField[7]" value="6">  
		<input type="hidden" name="FilterOperator[7]" value="less-than-or-equal-to">
		
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text" class="form-control" id="to-date_6" name="FilterValue[7]" value="<?php echo htmlspecialchars($FilterValue[7]); ?>" size="10">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<input type="hidden" name="FilterField[8]" value="7">   
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" class="populatedLookupData" name="11" value="<?php echo htmlspecialchars($FilterValue[11]); ?>" >
			<input type="hidden" name="FilterAnd[11]" value="and">
			<input type="hidden" name="FilterField[11]" value="8">  
			<input type="hidden" id="lookupoperator_8" name="FilterOperator[11]" value="equal-to">
			<input type="hidden" id="filterfield_8" name="FilterValue[11]" value="<?php echo htmlspecialchars($FilterValue[11]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Coût total prévionnel</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Coût total prévionnel</label></div>
		
					
		<div class="col-xs-3 col-md-1 vspacer-lg text-center">Between</div>
		<input type="hidden" name="FilterAnd[12]" value="and">
		<input type="hidden" name="FilterField[12]" value="10">   
		...
		<input type="hidden" name="FilterField[13]" value="10">  
