...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="lignes_credits-convention sum"></td>';
			$sumRow .= '<td class="lignes_credits-ligne_budgetaire sum"></td>';
			$sumRow .= '<td class="lignes_credits-intitule sum"></td>';
			$sumRow .= '<td class="lignes_credits-exercice sum"></td>';
			$sumRow .= '<td class="lignes_credits-notes sum"></td>';
			$sumRow .= "<td class=\"lignes_credits-ouvert text-right sum\">{$row[0]}</td>";
			$sumRow .= "<td class=\"lignes_credits-non_liquide text-right sum\">{$row[1]}</td>";
			$sumRow .= "<td class=\"lignes_credits-liquide text-right sum\">{$row[2]}</td>";
			$sumRow .= "<td class=\"lignes_credits-utilise text-right sum\">{$row[3]}</td>";
			$sumRow .= "<td class=\"lignes_credits-disponible text-right sum\">{$row[4]}</td>";
			$sumRow .= '<td class="lignes_credits-prop_uo sum"></td>';
			$sumRow .= '</tr>';
