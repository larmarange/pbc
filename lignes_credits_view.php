...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"CONCAT('<span style=''color: ', IF(`lignes_credits`.`utilise` < 0, 'red', 'black'), ';''>', FORMAT(`lignes_credits`.`utilise`, 2, 'ru_RU'), '</span>')" => "utilise",
		"CONCAT('<span style=''color: ', IF(`lignes_credits`.`disponible` < 0, 'red', 'black'), ';''>', FORMAT(`lignes_credits`.`disponible`, 2, 'ru_RU'), '</span>')" => "disponible",
	...
	$x->SortFields = array(   
		...
		4 => 4,
		5 => 5,
		6 => '`lignes_credits`.`ouvert`',
		7 => '`lignes_credits`.`reserve`',
		8 => '`lignes_credits`.`liquide`',
		9 => '`lignes_credits`.`utilise`',
		10 => '`lignes_credits`.`disponible`',
		11 => '`lignes_credits`.`prop_uo`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`lignes_credits`.`reserve`" => "Reserv&#233;",
	...
	$x->ColCaption = array("Convention", "Ligne Budg&#233;taire", "Intitul&#233; / CFI", "Notes", "Ouvert", "Reserv&#233;", "Liquid&#233;", "Utilis&#233;", "Disponible", "U/O (%)");
	$x->ColFieldName = array('convention', 'ligne_budgetaire', 'intitule', 'notes', 'ouvert', 'reserve', 'liquide', 'utilise', 'disponible', 'prop_uo');
	...
	if(strpos($x->HTML, '<!-- tv data below -->')){
		...
		$sumQuery = "select CONCAT('<span style=''color: ', IF(sum(`lignes_credits`.`ouvert`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`lignes_credits`.`ouvert`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`lignes_credits`.`reserve`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`lignes_credits`.`reserve`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`lignes_credits`.`liquide`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`lignes_credits`.`liquide`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`lignes_credits`.`utilise`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`lignes_credits`.`utilise`), 2, 'ru_RU'), '</span>'), CONCAT('<span style=''color: ', IF(sum(`lignes_credits`.`disponible`) < 0, 'red', 'black'), ';''>', FORMAT(sum(`lignes_credits`.`disponible`), 2, 'ru_RU'), '</span>') from {$x->QueryFrom} {$QueryWhere}";
		$res = sql($sumQuery, $eo);
