<?php
	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		/* table groups */
		$tg = array(
			'Pilotage Bud&#233;gtaire des Conventions',
			'Param&#232;tres'
		);
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'conventions' => array(
					'Caption' => 'Conventions',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/035-legal-document.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'budgets' => array(
					'Caption' => 'Lignes budg&#233;taires',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/006-business.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'versements' => array(
					'Caption' => 'Versements (bailleur)',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/009-cash.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'lignes_credits' => array(
					'Caption' => 'Lignes de Cr&#233;dits',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/044-prince2.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'credits' => array(
					'Caption' => 'Cr&#233;dits (ouverture)',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/051-revenue.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'rubriques' => array(
				...
				'fichiers' => array(
					'Caption' => 'Fichiers',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/025-exchange.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'personnes' => array(
					'Caption' => 'Individus',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/023-human-resources.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'types_ligne' => array(
					'Caption' => 'Type de lignes budg&#233;taires',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/034-mechanism.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
		);
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				...
				'fichiers' => 'Fichiers',
				'personnes' => 'Individus',
				'types_ligne' => 'Type de lignes budg&#233;taires',
			);
