...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->SortFields = array(   
		...
		8 => '`ventilation1`.`intitule`',
		9 => 9,
		10 => '`recrutements`.`previsionnel`',
		11 => '`recrutements`.`depense`',
		12 => '`recrutements`.`reservation_salaire`',
		13 => '`recrutements`.`prop_dp`'
	);
	...
	$x->filterers = array(  'convention' => 'Convention', 'beneficiaire' => 'B&#233;n&#233;ficiaire', 'ventilation' => 'Ventilation Budg&#233;taire');

	$x->QueryFrom = "`recrutements` LEFT JOIN `conventions` as conventions1 ON `conventions1`.`id`=`recrutements`.`convention` LEFT JOIN `personnes` as personnes1 ON `personnes1`.`id`=`recrutements`.`beneficiaire` LEFT JOIN `ventilation` as ventilation1 ON `ventilation1`.`id`=`recrutements`.`ventilation` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
