...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="recrutements-convention sum"></td>';
			$sumRow .= '<td class="recrutements-intitule sum"></td>';
			$sumRow .= '<td class="recrutements-beneficiaire sum"></td>';
			$sumRow .= '<td class="recrutements-date_debut sum"></td>';
			$sumRow .= '<td class="recrutements-date_fin sum"></td>';
			$sumRow .= '<td class="recrutements-duree sum"></td>';
			$sumRow .= '<td class="recrutements-ligne_budgetaire sum"></td>';
			$sumRow .= '<td class="recrutements-ventilation sum"></td>';
			$sumRow .= '<td class="recrutements-notes sum"></td>';
			$sumRow .= "<td class=\"recrutements-previsionnel text-right sum\">{$row[0]}</td>";
			$sumRow .= "<td class=\"recrutements-depense text-right sum\">{$row[1]}</td>";
			$sumRow .= "<td class=\"recrutements-reservation_salaire text-right sum\">{$row[2]}</td>";
			$sumRow .= '<td class="recrutements-prop_dp sum"></td>';
			$sumRow .= '</tr>';
