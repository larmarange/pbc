...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="ventilation-convention sum"></td>';
			$sumRow .= '<td class="ventilation-rubrique sum"></td>';
			$sumRow .= '<td class="ventilation-intitule sum"></td>';
			$sumRow .= '<td class="ventilation-notes sum"></td>';
			$sumRow .= "<td class=\"ventilation-accorde text-right sum\">{$row[0]}</td>";
			$sumRow .= "<td class=\"ventilation-non_liquide text-right sum\">{$row[1]}</td>";
			$sumRow .= "<td class=\"ventilation-liquide text-right sum\">{$row[2]}</td>";
			$sumRow .= "<td class=\"ventilation-utilise text-right sum\">{$row[3]}</td>";
			$sumRow .= "<td class=\"ventilation-reste_engager text-right sum\">{$row[4]}</td>";
			$sumRow .= "<td class=\"ventilation-reservation_salaire text-right sum\">{$row[5]}</td>";
			$sumRow .= "<td class=\"ventilation-reste_depenser text-right sum\">{$row[6]}</td>";
			$sumRow .= '<td class="ventilation-prop_ua sum"></td>';
			$sumRow .= '</tr>';
