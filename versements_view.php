...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="versements-convention sum"></td>';
			$sumRow .= '<td class="versements-ligne_budgetaire sum"></td>';
			$sumRow .= '<td class="versements-date sum"></td>';
			$sumRow .= '<td class="versements-intitule sum"></td>';
			$sumRow .= "<td class=\"versements-montant text-right sum\">{$row[0]}</td>";
			$sumRow .= '<td class="versements-notes sum"></td>';
			$sumRow .= '</tr>';
