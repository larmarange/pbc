...
function conventions_validateData() {
	...
	if(!AppGini.Validation.fieldRequired('text', 'nom', 'Nom')) return false;
	if(!AppGini.Validation.fieldRequired('list', 'statut', 'Statut')) return false;
...
function budgets_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'convention', 'Convention')) return false;
	if(!AppGini.Validation.fieldRequired('radio', 'type', 'Type')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'accorde', 'Accord&#233;')) return false;
...
function versements_validateData() {
	...
	[
		...
		['lookup', 'ligne_budgetaire', 'Ligne Budg&#233;taire'],
		['date', 'date', 'Date'],
...
function credits_validateData() {
	...
	[
		// [field-type, field-name, field-caption], ...
		['lookup', 'convention', 'Convention'],
		['lookup', 'ligne_credit', 'Ligne de cr&#233;dit (CFI) - Exercice'],
		['date', 'date', 'Date'],
		['text', 'montant', 'Montant'],
		[]
	].map(function(rf) {
...
function rubriques_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'convention', 'Convention')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'intitule', 'Intitul&#233;')) return false;
...
function recrutements_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'convention', 'Convention')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'intitule', 'Intitul&#233; du poste')) return false;
...
function fichiers_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'convention', 'Convention')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'titre', 'Titre')) return false;

	// check file uploads (file type and size)
	if($j('#fichier').val() && !AppGini.checkFileUpload('fichier', 'txt|doc|docx|docm|odt|pdf|rtf|jpg|png|gif|csv|xls|xlsx|xlsm|ods|zip|rar|gz|tar|iso', 1024000000)) {
		AppGini.scrollTo('fichier');
		return false;
	}
...
function personnes_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('text', 'nom', 'Pr&#233;nom Nom')) return false;
...
function types_ligne_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('text', 'gestionnaire', 'Organisme gestionnaire')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'type', 'Type')) return false;
