...
function ventilation_insert(&$error_message = '') {
	...
	$data = [
		...
		'rubrique' => Request::lookup('rubrique', ''),
...
function ventilation_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	<script>
		...
		AppGini.current_rubrique__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['rubrique'] : htmlspecialchars($filterer_rubrique, ENT_QUOTES)); ?>"};
