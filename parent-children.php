		...
		$pcConfig = array(
			...
			'ventilation' => array(
				'convention' => array(
					...
					'sortable-fields' => array(0 => '`ventilation`.`id`', 1 => '`conventions1`.`nom`', 2 => 3, 3 => 4, 4 => '`ventilation`.`accorde`', 5 => '`ventilation`.`reserve`', 6 => '`ventilation`.`liquide`', 7 => '`ventilation`.`utilise`', 8 => '`ventilation`.`reste_engager`', 9 => '`ventilation`.`reservation_salaire`', 10 => '`ventilation`.`reste_depenser`', 11 => '`ventilation`.`prop_ua`'),
					'records-per-page' => 50,
					'default-sort-by' => 1,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
