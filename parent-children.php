		...
		$pcConfig = array(
			'conventions' => array(
				'porteur' => array(
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'Nom', 2 => 'Statut', 3 => 'Bailleur(s)', 4 => 'Porteur', 5 => 'Date r&#233;ponse', 6 => 'Demand&#233;', 7 => 'D&#233;but', 8 => 'Fin', 9 => 'Dur&#233;e (mois)', 11 => 'Accord&#233; hors FG', 12 => 'Frais de Gestion', 13 => 'Total Accord&#233;', 14 => 'Vers&#233;', 15 => 'Reste &#224; Verser', 16 => 'Vers&#233; hors FG', 17 => 'Ouvert', 18 => 'Reste &#224; Ouvrir', 19 => 'R&#233;serv&#233;', 20 => 'Liquid&#233;', 21 => 'Utilis&#233; (R+L)', 22 => 'Disponible (O-U)', 23 => 'Reste &#224; Engager', 24 => 'Salaires restant &#224; verser', 25 => 'Reste &#224; D&#233;penser', 26 => 'U/O (%)', 27 => 'U/V (%)', 28 => 'U/A (%, hors FG)', 29 => 'Budget non ventil&#233;', 30 => 'D&#233;penses non ventil&#233;es'),
					'display-field-names' => array(1 => 'nom', 2 => 'statut', 3 => 'bailleur', 4 => 'porteur', 5 => 'date_reponse', 6 => 'demande', 7 => 'date_debut', 8 => 'date_fin', 9 => 'duree', 11 => 'accorde_hfg', 12 => 'frais_gestion', 13 => 'accorde', 14 => 'verse', 15 => 'reste_verser', 16 => 'verse_hfg', 17 => 'ouvert', 18 => 'reste_ouvrir', 19 => 'reserve', 20 => 'liquide', 21 => 'utilise', 22 => 'disponible', 23 => 'reste_engager', 24 => 'reservation_salaire', 25 => 'reste_depenser', 26 => 'prop_uo', 27 => 'prop_uv', 28 => 'prop_ua', 29 => 'budget_nv', 30 => 'depenses_nv'),
					'sortable-fields' => array(0 => '`conventions`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`personnes1`.`nom`', 5 => '`conventions`.`date_reponse`', 6 => '`conventions`.`demande`', 7 => '`conventions`.`date_debut`', 8 => '`conventions`.`date_fin`', 9 => '`conventions`.`duree`', 10 => 11, 11 => '`conventions`.`accorde_hfg`', 12 => '`conventions`.`frais_gestion`', 13 => '`conventions`.`accorde`', 14 => '`conventions`.`verse`', 15 => '`conventions`.`reste_verser`', 16 => '`conventions`.`verse_hfg`', 17 => '`conventions`.`ouvert`', 18 => '`conventions`.`reste_ouvrir`', 19 => '`conventions`.`reserve`', 20 => '`conventions`.`liquide`', 21 => '`conventions`.`utilise`', 22 => '`conventions`.`disponible`', 23 => '`conventions`.`reste_engager`', 24 => '`conventions`.`reservation_salaire`', 25 => '`conventions`.`reste_depenser`', 26 => '`conventions`.`prop_uo`', 27 => '`conventions`.`prop_uv`', 28 => '`conventions`.`prop_ua`', 29 => '`conventions`.`budget_nv`', 30 => '`conventions`.`depenses_nv`'),
					'records-per-page' => 10,
					'default-sort-by' => 8,
			...
			'rubriques' => array(
				'convention' => array(
					...
					'query' => "SELECT `rubriques`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', `rubriques`.`intitule` as 'intitule', if(CHAR_LENGTH(`rubriques`.`notes`)>80, concat(left(`rubriques`.`notes`,80),' ...'), `rubriques`.`notes`) as 'notes', CONCAT('<span style=''color: ', IF(`rubriques`.`accorde` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`accorde`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'accorde', CONCAT('<span style=''color: ', IF(`rubriques`.`reserve` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reserve`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'reserve', CONCAT('<span style=''color: ', IF(`rubriques`.`liquide` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`liquide`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'liquide', CONCAT('<span style=''color: ', IF(`rubriques`.`utilise` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`utilise`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'utilise', CONCAT('<span style=''color: ', IF(`rubriques`.`reste_engager` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_engager`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'reste_engager', CONCAT('<span style=''color: ', IF(`rubriques`.`reservation_salaire` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reservation_salaire`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'reservation_salaire', CONCAT('<span style=''color: ', IF(`rubriques`.`reste_depenser` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_depenser`, 2, 'ru_RU'), '&nbsp;&euro;</span>') as 'reste_depenser', CONCAT('<span style=''color: ', IF(`rubriques`.`prop_ua` > 100, 'red', 'black'), ';''>', FORMAT(`rubriques`.`prop_ua`, 0, 'ru_RU'), '%</span>') as 'prop_ua' FROM `rubriques` LEFT JOIN `conventions` as conventions1 ON `conventions1`.`id`=`rubriques`.`convention` "
				),
			),
			'ventilation' => array(
				'convention' => array(
			...
			'recrutements' => array(
				...
				'ventilation' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Recrutements <span class="hidden child-label-recrutements child-field-caption">(Ventilation Budg&#233;taire)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/067-human-resources-1.png',
					'display-refresh' => true,
					'display-add-new' => true,
			...
			'depenses' => array(
				'convention' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Ligne Budg&#233;taire', 3 => 'Ligne de cr&#233;dit (CFI) - Exercice', 4 => 'Date', 5 => 'Intitul&#233;', 6 => 'Contrat (si salaire)', 7 => 'B&#233;n&#233;ficiaire', 8 => 'Montant', 9 => 'Statut', 10 => 'Ventilation Budg&#233;taire', 11 => 'Notes'),
					'display-field-names' => array(1 => 'convention', 2 => 'ligne_budgetaire', 3 => 'ligne_credit', 4 => 'date', 5 => 'intitule', 6 => 'contrat', 7 => 'beneficiaire', 8 => 'montant', 9 => 'statut', 10 => 'ventilation', 11 => 'notes'),
					'sortable-fields' => array(0 => '`depenses`.`id`', 1 => '`conventions1`.`nom`', 2 => 3, 3 => 4, 4 => '`depenses`.`date`', 5 => 6, 6 => 7, 7 => '`personnes2`.`nom`', 8 => '`depenses`.`montant`', 9 => 10, 10 => '`ventilation1`.`intitule`', 11 => 12),
					'records-per-page' => 10,
					'default-sort-by' => 4,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
