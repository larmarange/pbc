		...
		$pcConfig = array(
			...
			'budgets' => array(
				'convention' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Type', 3 => 'Accord&#233;', 4 => 'Vers&#233;', 5 => 'Reste &#224; Verser', 6 => 'Ouvert', 7 => 'Reste &#224; Ouvrir', 8 => 'Non Liquid&#233;', 9 => 'Liquid&#233;', 10 => 'Utilis&#233;', 11 => 'Disponible', 12 => 'Reste &#224; Engager', 13 => 'Salaires restant &#224; verser', 14 => 'Reste &#224; D&#233;penser', 15 => 'U/O (%)', 16 => 'U/V (%)', 17 => 'U/A (%)'),
					'display-field-names' => array(1 => 'convention', 2 => 'type', 3 => 'accorde', 4 => 'verse', 5 => 'reste_verser', 6 => 'ouvert', 7 => 'reste_ouvrir', 8 => 'non_liquide', 9 => 'liquide', 10 => 'utilise', 11 => 'disponible', 12 => 'reste_engager', 13 => 'reservation_salaire', 14 => 'reste_depenser', 15 => 'prop_uo', 16 => 'prop_uv', 17 => 'prop_ua'),
					'sortable-fields' => array(0 => '`budgets`.`id`', 1 => '`conventions1`.`nom`', 2 => 3, 3 => '`budgets`.`accorde`', 4 => '`budgets`.`verse`', 5 => '`budgets`.`reste_verser`', 6 => '`budgets`.`ouvert`', 7 => '`budgets`.`reste_ouvrir`', 8 => '`budgets`.`non_liquide`', 9 => '`budgets`.`liquide`', 10 => '`budgets`.`utilise`', 11 => '`budgets`.`disponible`', 12 => '`budgets`.`reste_engager`', 13 => '`budgets`.`reservation_salaire`', 14 => '`budgets`.`reste_depenser`', 15 => '`budgets`.`prop_uo`', 16 => '`budgets`.`prop_uv`', 17 => '`budgets`.`prop_ua`'),
					'records-per-page' => 50,
					'default-sort-by' => 2,
			...
			'depenses' => array(
				'convention' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Ligne Budg&#233;taire', 3 => 'Ligne de cr&#233;dit (CFI) - Exercice', 4 => 'Date', 5 => 'Intitul&#233;', 6 => 'R&#233;ference', 7 => 'Contrat (si salaire)', 8 => 'B&#233;n&#233;ficiaire', 9 => 'Montant', 10 => 'Liquid&#233;e ?', 11 => 'Ventilation Budg&#233;taire', 12 => 'Notes', 13 => 'V&#233;rifi&#233;e ?'),
