		...
		$pcConfig = array(
			...
			'ventilation' => array(   
				'convention' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Intitul&#233;', 3 => 'Notes', 4 => 'Pr&#233;visionnel', 5 => 'R&#233;serv&#233;', 6 => 'Liquid&#233;', 7 => 'Utilis&#233;', 8 => 'Reste &#224; Engager', 9 => 'U/P (%)'),
					...
					'query' => "SELECT `ventilation`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', `ventilation`.`intitule` as 'intitule', if(CHAR_LENGTH(`ventilation`.`notes`)>80, concat(left(`ventilation`.`notes`,80),' ...'), `ventilation`.`notes`) as 'notes', CONCAT('$', FORMAT(`ventilation`.`accorde`, 2)) as 'accorde', CONCAT('$', FORMAT(`ventilation`.`reserve`, 2)) as 'reserve', CONCAT('$', FORMAT(`ventilation`.`liquide`, 2)) as 'liquide', CONCAT('$', FORMAT(`ventilation`.`utilise`, 2)) as 'utilise', CONCAT('$', FORMAT(`ventilation`.`reste_engager`, 2)) as 'reste_engager', CONCAT('&euro;', FORMAT(`ventilation`.`prop_ua`, 2)) as 'prop_ua' FROM `ventilation` LEFT JOIN `conventions` as conventions1 ON `conventions1`.`id`=`ventilation`.`convention` "
				)
			),
			'depenses' => array(   
				'convention' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Ligne Budg&#233;taire', 3 => 'Ligne de cr&#233;dit (CFI) - Exercice', 4 => 'Date', 5 => 'Intitul&#233;', 6 => 'B&#233;n&#233;ficiaire', 7 => 'Montant', 8 => 'Statut', 9 => 'Ventilation Budg&#233;taire', 10 => 'Notes'),
					...
					'sortable-fields' => array(0 => '`depenses`.`id`', 1 => '`conventions1`.`nom`', 2 => 3, 3 => 4, 4 => '`depenses`.`date`', 5 => 6, 6 => '`personnes1`.`nom`', 7 => '`depenses`.`montant`', 8 => 9, 9 => '`ventilation1`.`intitule`', 10 => 11),
					'records-per-page' => 10,
					'default-sort-by' => 4,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
