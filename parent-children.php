		...
		$pcConfig = array(
			...
			'budgets' => array(
				'convention' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Type', 3 => 'Accord&#233;', 4 => 'Vers&#233;', 5 => 'Reste &#224; Verser', 6 => 'Ouvert', 7 => 'Reste &#224; Ouvrir', 8 => 'R&#233;serv&#233;', 9 => 'Liquid&#233;', 10 => 'Utilis&#233;', 11 => 'Disponible', 12 => 'Reste &#224; Engager', 13 => 'U/O (%)', 14 => 'U/V (%)', 15 => 'U/A (%)'),
			...
			'rubriques' => array(
				'convention' => array(
					...
					'query' => "SELECT `rubriques`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', `rubriques`.`intitule` as 'intitule', if(CHAR_LENGTH(`rubriques`.`notes`)>80, concat(left(`rubriques`.`notes`,80),' ...'), `rubriques`.`notes`) as 'notes', CONCAT('<span style=''color: ', IF(`rubriques`.`accorde` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`accorde`, 2, 'ru_RU'), '</span>') as 'accorde', CONCAT('<span style=''color: ', IF(`rubriques`.`reserve` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reserve`, 2, 'ru_RU'), '</span>') as 'reserve', CONCAT('<span style=''color: ', IF(`rubriques`.`liquide` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`liquide`, 2, 'ru_RU'), '</span>') as 'liquide', CONCAT('<span style=''color: ', IF(`rubriques`.`utilise` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`utilise`, 2, 'ru_RU'), '</span>') as 'utilise', CONCAT('<span style=''color: ', IF(`rubriques`.`reste_engager` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_engager`, 2, 'ru_RU'), '</span>') as 'reste_engager', CONCAT('<span style=''color: ', IF(`rubriques`.`reservation_salaire` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reservation_salaire`, 2, 'ru_RU'), '</span>') as 'reservation_salaire', CONCAT('<span style=''color: ', IF(`rubriques`.`reste_depenser` < 0, 'red', 'black'), ';''>', FORMAT(`rubriques`.`reste_depenser`, 2, 'ru_RU'), '</span>') as 'reste_depenser', CONCAT('<span style=''color: ', IF(`rubriques`.`prop_ua` > 100, 'red', 'black'), ';''>', FORMAT(`rubriques`.`prop_ua`, 0, 'ru_RU'), '%</span>') as 'prop_ua' FROM `rubriques` LEFT JOIN `conventions` as conventions1 ON `conventions1`.`id`=`rubriques`.`convention` "
				)
			),
			'ventilation' => array(
				'convention' => array(
			...
			'recrutements' => array(
				'convention' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Convention', 2 => 'Intitul&#233; du poste', 3 => 'B&#233;n&#233;ficiaire', 4 => 'D&#233;but', 5 => 'Fin', 6 => 'Dur&#233;e (mois)', 7 => 'Ventilation Budg&#233;taire', 8 => 'Notes', 9 => 'Co&#251;t total pr&#233;visionnel', 10 => 'D&#233;pens&#233;', 11 => 'Salaires restant &#224; verser', 12 => 'D/P (%)'),
					'display-field-names' => array(1 => 'convention', 2 => 'intitule', 3 => 'beneficiaire', 4 => 'date_debut', 5 => 'date_fin', 6 => 'duree', 7 => 'ventilation', 8 => 'notes', 9 => 'previsionnel', 10 => 'depense', 11 => 'reservation_salaire', 12 => 'prop_dp'),
					'sortable-fields' => array(0 => '`recrutements`.`id`', 1 => '`conventions1`.`nom`', 2 => 3, 3 => '`personnes1`.`nom`', 4 => '`recrutements`.`date_debut`', 5 => '`recrutements`.`date_fin`', 6 => '`recrutements`.`duree`', 7 => '`ventilation1`.`intitule`', 8 => 9, 9 => '`recrutements`.`previsionnel`', 10 => '`recrutements`.`depense`', 11 => '`recrutements`.`reservation_salaire`', 12 => '`recrutements`.`prop_dp`'),
					'records-per-page' => 50,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
