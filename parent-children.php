		...
		$pcConfig = array(
			...
			'ventilation' => array(
				'convention' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Ventilation Analytique <span class="hidden child-label-ventilation child-field-caption">(Convention)</span>',
					'auto-close' => true,
				...
				'rubrique' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Ventilation Analytique <span class="hidden child-label-ventilation child-field-caption">(Rubrique de Ventilation)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/024-tasks.png',
					'display-refresh' => true,
					'display-add-new' => true,
