<?php
	...
	*/
	...
	function get_sql_fields($table_name){
		$sql_fields = array(   
			'conventions' => "`conventions`.`id` as 'id', `conventions`.`nom` as 'nom', `conventions`.`statut` as 'statut', `conventions`.`bailleur` as 'bailleur', IF(    CHAR_LENGTH(`personnes1`.`nom`), CONCAT_WS('',   `personnes1`.`nom`), '') as 'porteur', if(`conventions`.`date_reponse`,date_format(`conventions`.`date_reponse`,'%d/%m/%Y'),'') as 'date_reponse', CONCAT('$', FORMAT(`conventions`.`demande`, 2)) as 'demande', if(`conventions`.`date_debut`,date_format(`conventions`.`date_debut`,'%d/%m/%Y'),'') as 'date_debut', if(`conventions`.`date_fin`,date_format(`conventions`.`date_fin`,'%d/%m/%Y'),'') as 'date_fin', `conventions`.`duree` as 'duree', `conventions`.`notes` as 'notes', CONCAT('$', FORMAT(`conventions`.`accorde_hfg`, 2)) as 'accorde_hfg', CONCAT('$', FORMAT(`conventions`.`frais_gestion`, 2)) as 'frais_gestion', CONCAT('$', FORMAT(`conventions`.`accorde`, 2)) as 'accorde', CONCAT('$', FORMAT(`conventions`.`verse`, 2)) as 'verse', CONCAT('$', FORMAT(`conventions`.`reste_verser`, 2)) as 'reste_verser', CONCAT('$', FORMAT(`conventions`.`verse_hfg`, 2)) as 'verse_hfg', CONCAT('$', FORMAT(`conventions`.`ouvert`, 2)) as 'ouvert', CONCAT('$', FORMAT(`conventions`.`reste_ouvrir`, 2)) as 'reste_ouvrir', CONCAT('$', FORMAT(`conventions`.`reserve`, 2)) as 'reserve', CONCAT('$', FORMAT(`conventions`.`liquide`, 2)) as 'liquide', CONCAT('$', FORMAT(`conventions`.`utilise`, 2)) as 'utilise', CONCAT('$', FORMAT(`conventions`.`disponible`, 2)) as 'disponible', CONCAT('$', FORMAT(`conventions`.`reste_engager`, 2)) as 'reste_engager', CONCAT('&euro;', FORMAT(`conventions`.`prop_uo`, 2)) as 'prop_uo', CONCAT('&euro;', FORMAT(`conventions`.`prop_uv`, 2)) as 'prop_uv', CONCAT('&euro;', FORMAT(`conventions`.`prop_ua`, 2)) as 'prop_ua', CONCAT('$', FORMAT(`conventions`.`budget_nv`, 2)) as 'budget_nv', CONCAT('$', FORMAT(`conventions`.`depenses_nv`, 2)) as 'depenses_nv'",
			'budgets' => "`budgets`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', IF(    CHAR_LENGTH(`types_ligne1`.`gestionnaire`) || CHAR_LENGTH(`types_ligne1`.`type`), CONCAT_WS('',   `types_ligne1`.`gestionnaire`, ' - ', `types_ligne1`.`type`), '') as 'type', CONCAT('$', FORMAT(`budgets`.`accorde`, 2)) as 'accorde', CONCAT('$', FORMAT(`budgets`.`verse`, 2)) as 'verse', CONCAT('$', FORMAT(`budgets`.`reste_verser`, 2)) as 'reste_verser', CONCAT('$', FORMAT(`budgets`.`ouvert`, 2)) as 'ouvert', CONCAT('$', FORMAT(`budgets`.`reste_ouvrir`, 2)) as 'reste_ouvrir', CONCAT('$', FORMAT(`budgets`.`reserve`, 2)) as 'reserve', CONCAT('$', FORMAT(`budgets`.`liquide`, 2)) as 'liquide', CONCAT('$', FORMAT(`budgets`.`utilise`, 2)) as 'utilise', CONCAT('$', FORMAT(`budgets`.`disponible`, 2)) as 'disponible', CONCAT('$', FORMAT(`budgets`.`reste_engager`, 2)) as 'reste_engager', CONCAT('&euro;', FORMAT(`budgets`.`prop_uo`, 2)) as 'prop_uo', CONCAT('&euro;', FORMAT(`budgets`.`prop_uv`, 2)) as 'prop_uv', CONCAT('&euro;', FORMAT(`budgets`.`prop_ua`, 2)) as 'prop_ua'",
			'versements' => "`versements`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', IF(    CHAR_LENGTH(`types_ligne1`.`gestionnaire`) || CHAR_LENGTH(`types_ligne1`.`type`), CONCAT_WS('',   `types_ligne1`.`gestionnaire`, ' - ', `types_ligne1`.`type`), '') as 'ligne_budgetaire', if(`versements`.`date`,date_format(`versements`.`date`,'%d/%m/%Y'),'') as 'date', `versements`.`intitule` as 'intitule', CONCAT('$', FORMAT(`versements`.`montant`, 2)) as 'montant', `versements`.`notes` as 'notes'",
			'lignes_credits' => "`lignes_credits`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', IF(    CHAR_LENGTH(`types_ligne1`.`gestionnaire`) || CHAR_LENGTH(`types_ligne1`.`type`), CONCAT_WS('',   `types_ligne1`.`gestionnaire`, ' - ', `types_ligne1`.`type`), '') as 'ligne_budgetaire', `lignes_credits`.`intitule` as 'intitule', `lignes_credits`.`exercice` as 'exercice', `lignes_credits`.`notes` as 'notes', CONCAT('$', FORMAT(`lignes_credits`.`ouvert`, 2)) as 'ouvert', CONCAT('$', FORMAT(`lignes_credits`.`reserve`, 2)) as 'reserve', CONCAT('$', FORMAT(`lignes_credits`.`liquide`, 2)) as 'liquide', CONCAT('$', FORMAT(`lignes_credits`.`utilise`, 2)) as 'utilise', CONCAT('$', FORMAT(`lignes_credits`.`disponible`, 2)) as 'disponible', CONCAT('&euro;', FORMAT(`lignes_credits`.`prop_uo`, 2)) as 'prop_uo'",
			...
			'ventilation' => "`ventilation`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', `ventilation`.`intitule` as 'intitule', `ventilation`.`notes` as 'notes', CONCAT('$', FORMAT(`ventilation`.`accorde`, 2)) as 'accorde', CONCAT('$', FORMAT(`ventilation`.`reserve`, 2)) as 'reserve', CONCAT('$', FORMAT(`ventilation`.`liquide`, 2)) as 'liquide', CONCAT('$', FORMAT(`ventilation`.`utilise`, 2)) as 'utilise', CONCAT('$', FORMAT(`ventilation`.`reste_engager`, 2)) as 'reste_engager', CONCAT('&euro;', FORMAT(`ventilation`.`prop_ua`, 2)) as 'prop_ua'",
			'depenses' => "`depenses`.`id` as 'id', IF(    CHAR_LENGTH(`conventions1`.`nom`), CONCAT_WS('',   `conventions1`.`nom`), '') as 'convention', IF(    CHAR_LENGTH(`types_ligne1`.`gestionnaire`) || CHAR_LENGTH(`types_ligne1`.`type`), CONCAT_WS('',   `types_ligne1`.`gestionnaire`, ' - ', `types_ligne1`.`type`), '') as 'ligne_budgetaire', IF(    CHAR_LENGTH(`lignes_credits1`.`intitule`) || CHAR_LENGTH(`lignes_credits1`.`exercice`), CONCAT_WS('',   `lignes_credits1`.`intitule`, ' - ', `lignes_credits1`.`exercice`), '') as 'ligne_credit', if(`depenses`.`date`,date_format(`depenses`.`date`,'%d/%m/%Y'),'') as 'date', `depenses`.`intitule` as 'intitule', IF(    CHAR_LENGTH(`personnes1`.`nom`), CONCAT_WS('',   `personnes1`.`nom`), '') as 'beneficiaire', CONCAT('$', FORMAT(`depenses`.`montant`, 2)) as 'montant', `depenses`.`statut` as 'statut', IF(    CHAR_LENGTH(`ventilation1`.`intitule`), CONCAT_WS('',   `ventilation1`.`intitule`), '') as 'ventilation', `depenses`.`notes` as 'notes'",
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false) {
		$sql_from = array(   
			...
			'depenses' => "`depenses` LEFT JOIN `conventions` as conventions1 ON `conventions1`.`id`=`depenses`.`convention` LEFT JOIN `budgets` as budgets1 ON `budgets1`.`id`=`depenses`.`ligne_budgetaire` LEFT JOIN `types_ligne` as types_ligne1 ON `types_ligne1`.`id`=`budgets1`.`type` LEFT JOIN `lignes_credits` as lignes_credits1 ON `lignes_credits1`.`id`=`depenses`.`ligne_credit` LEFT JOIN `personnes` as personnes1 ON `personnes1`.`id`=`depenses`.`beneficiaire` LEFT JOIN `ventilation` as ventilation1 ON `ventilation1`.`id`=`depenses`.`ventilation` ",
